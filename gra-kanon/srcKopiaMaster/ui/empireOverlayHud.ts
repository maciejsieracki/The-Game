...
export function showCultureOverlay(data: CultureOverlayData, onClose?: () => void): void {
  ...
  body += '<p style="font-size:11px;color:#7a8494;margin-top:8px">Klik 🎭 przy minimapie = zasięg na mapie · dblclick = ten panel.</p>';
...
export function showReligionOverlay(data: ReligionOverlayData, onClose?: () => void): void {
  ...
  body += '</table><p style="font-size:11px;color:#7a8494;margin-top:8px">Klik ⛪ przy minimapie = zasięg na mapie · dblclick = ten panel.</p>';
