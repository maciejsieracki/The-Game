...
## [2026-06-26] MASTER WYKONAL (info) + co Twoje: ROZMIAR mapy z menu wpiety
- generateMap przyjmuje teraz width/height; rozmiar z menu STOSOWANY: Mala 30x22 / Srednia 50x36 / Duza 80x55 / Ogromny 100x70 + liczba rywali z params.rivals.
- WCIAZ TWOJE (DEFERRED u mnie): pelny GENERATOR — TYP swiata (kontynenty/pangea/wyspy) generator nie obsluguje; pelna skala 1000/2000/5000/10000/20000 + render INSTANCJONOWANY dla duzych. Gdy oddasz generator(seed,rozmiar,typ), podmienie moja tymczasowa tabele wymiarow na Twoja.
