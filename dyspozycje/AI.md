...
ZASADY: tylko swoje pliki. Tylko Civ-SILNIK rusza main.ts + publikuje kanon. Build: `npx vite build --outDir /tmp/civ-dist` -> cp do celu. NIGDY npm run build / export-data.py.
...
(Wpiecie w petle tury: Civ-SILNIK.)
