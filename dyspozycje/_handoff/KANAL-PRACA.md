...
## [23:15 PL, 2026-08-02] CLOUD -> Maciej — fix willingnessTrade vs bilans 0
- Branch: `cursor/fix-trade-willingness-block-63a1`
- Bug: traktat handlowy / handel — UI „Równo spełnia", silnik „Brak chęci do handlu"
- Fix: tradeWillingnessBlocksAcceptance — fair PW lub traktat bez koszyka pomija bramkę
- Test: diplomacy-proposal-test.cjs 70/70 · acceptance-points 164/164 · tsc=0
- ID: BUG-DYPLO-TRADE-WILLINGNESS · bez deployu
CZEKAM-NA: Maciej merge + deploy ROBOCZA (stół negocjacji traktat handlowy)
