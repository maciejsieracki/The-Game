## [22:00 PL, 2026-08-04] CLOUD → Maciej — R-BUDOWA-ZROWNOWAZONE-TRYB-Q1=A (kod, bez deploy)
- ECHO A: zrównoważony = osobny `budowaTryb`, nie 6. chip z numerem
- UI: 5 typów + osobny przełącznik; migracja legacy `[zrownowazone]` → tryb
- Branch: `cursor/fix-budowa-zrownowazone-tryb-63a1` · tsc 0 · auto-manage 45/45
