...
- Publish commit: `cff98d93d889664fe3664045be81927c7d793712`; remote readback and HTTP smoke `PASS`; no KANON/FINALNA promotion.

CZEKAM-NA: test właściciela w `gra-robocza`; baseline notes remain in Final Control receipt.
...
- Remote `origin/main` readback: `cfb960135b0daafdeba8190e8dbd2d0fc325b841`; primary bundle and manifest byte/hash match.
- HTTP smoke of the exact remote `Gra-ROBOCZA.html`: `200`, HTML/stamp present, SHA-256 `8330638ac6797258712014aff845fc0f9beaccf5d164d67b38ed42cbb04d5e2e`.
...
CZEKAM-NA: właściciel — playtest `gra-robocza`; Rust/R15 and owner-held topics remain separate.
...
🔴 **Playtest priorytetowo:** czy poziom racji reaguje **od razu** po zmianie wpływającej na żywność (bez czekania na koniec tury); czy `Wzrost%` jest **ten sam** w panelu, na karcie wzrostu i na plakietce miasta na mapie; czy niedostępne ulepszenia są wyszarzone i nieklikalne.
**Bramki na HEAD `225c8342`, wszystkie exit 0:** tsc 0 · logic **213/213** · tech-tree 19/19 · research 33/33 · unit-replace 13/13 · ai-founding-territory 28/28 · 7 bramek tematów tej fali **239 asercji, 0 porażek** (`auto-wyzywienie-live-recalc` 57/57 · `spichlerz-widocznosc` 45/45 · `spichlerz-deficyt-scalenie` 41/41 · `city-badge-growth-percent` 38/38 · `city-panel-growth-percent-separator` 29/29 · `auto-wyzywienie-bilans-clamp` 22/22 · `build-mode-hud-affordability` 7/7) · vite **805 modułów** · **VERIFY OK** (`manifest match: OK`).
