# _handoff/ — jednokierunkowe paczki miedzy taskami

Tu task A zostawia GOTOWY artefakt dla taska B (np. spec, dane), ktorego B potrzebuje.
Nazewnictwo: OD-do-DO_temat.md   (np. DANE-do-UNITS_spec-jednostek-celt-germ.md)
