...
ZASADY: dzialasz TYLKO na swoich plikach. Tylko Grupa F rusza main.ts i publikuje kanon Gra-podglad.html.
...
[ ] 2. Spec JEDNOSTEK dla Celtow/Germanow (tabela: nazwa|rola/bron|epoka|wzor) -> przekazac Grupa C przez DO-MASTERA + czat.
...
- (religie/spoleczenstwo tez w Spoleczenstwo-parametry.xlsx -- arkusz "Religie cywilizacji", w razie potrzeby uzgodnij z Grupa F)
...
- Q4: regula 90 miast / klaster 10 POTWIERDZONA (9 typow x 10). To robota map-gen
  (Grupa A / Grupa F), nie Twoja — juz w Excelu jako pozycja. Ty nic z tym nie robisz.
