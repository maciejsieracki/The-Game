...
## [2026-07-03 ~22:35] **→ MIASTO: INFO od Master** — wyświetlanie statów jednostek (TW)

**Handoff:** `_handoff/MASTER-do-MIASTO_balans-jednostki-info-2026-07-03.md`

**Skrót:** panel miasta pokazuje TW w sekcji Walka (zgodnie z silnikiem po fixie sceny T). **Logika produkcji / ekonomii miasta bez zmian.** Ewentualna aktualizacja tekstów wiki (np. „Łucznik HP 12") — redakcja, nie kod produkcji.

**Powiązane:** `_handoff/MASTER-do-UNITS_balans-scena-T-2026-07-03.md`

## [2026-07-03 ~22:45] **→ MIASTO: INFO batch 2** — pełna mapa sync (bez zmian produkcji)

**Handoff:** `_handoff/MASTER-do-ALL-LANES_sync-TW-balans-2026-07-03.md`
