...
|---|---|---|---|---|
| R-TRUDNOSC-1 | „jakiś czas temu" (odtworzone 2026-07-24) | **Osobny poziom trudności dla PAŃSTW / MIAST, niezależny od poziomu trudności całej cywilizacji.** | **CZEKA-NA-DECYZJĘ** | Dziś NIE ISTNIEJE — trudność jest jedna globalna (`_menuDifficulty`); reszta (aiDiffLevel, wsparcie miast, zaufanie miast-państw) to jej pochodna. Do wdrożenia po wyborze zakresu: **A** per nacja AI · **B** per miasto · **C** oba (globalna baza + nadpisania). Musi respektować parytet AI. |
| R-UNIT-KOSZT-ŁUCZ | 2026-07-24 | Łucznicy brązowi = 1 Brąz czy 0 (jak Procarz)? | CZEKA-NA-DECYZJĘ | Domyślnie zostawione 1 Brąz (groty). |
| R-STAWKI-STROJENIE | 2026-07-24 | Docelowe stawki/koszty po obejrzeniu licznika w playteście | CZEKA-NA-PLAYTEST | Placeholdery: stawki wydobycia, bonusy 10%, upkeep −1 Praca, progi CUDA/Ludy Morza, cap magazynu 100/+100. |
