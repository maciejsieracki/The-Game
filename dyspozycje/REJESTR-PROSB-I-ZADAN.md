...
| `R-FEATURE-KARTY-ENCYKLOPEDIA-CIVPEDIA-Q1` | `DEPLOY-ROBOCZA (T4/T5/T7b/T8, FALA 309/311/312/313); T6/T9 ZINTEGROWANE` | T1+T1b+T3 FALA 307, T4 FALA 309, T8 FALA 311, T5 FALA 312, T7b FALA 313. **T6 (karta jednostki panel miasta/rekrutacja, jeden wspólny `unitAdapter.ts` z kartą mapy) + T9 (mostek gra-id, 4 warianty kopalni + 1 jednostka) ZINTEGROWANE do `main`**, oba trywialne fast-forward. Operator+Evaluator+Final Control PASS niezależnie, tabela porównawcza T6 zweryfikowana wiersz-po-wierszu. Czeka na deploy ROBOCZA. Następny krok: T10 (linkowanie krzyżowe, ostatni krok migracji). |
| `P-DESIGN-11-ZAKLADEK-DROBIAZGI-RUNDA-2-BEZ-AKCJI` | `ZINTEGROWANE` | N5/N9/N11/N12 naprawione w `empireDetailPanel.ts` zgodnie z ECHO. N5 ma znaną, udokumentowaną usterkę zaokrągleń (±1 złoto w ~10-20% kombinacji, kosmetyczna, nie dotyka skarbca) potwierdzoną niezależnie przez Evaluatora i Final Control. N1 zamknięte bez akcji. Operator→Evaluator→Final Control PASS/PASS-WITH-NOTES. Zintegrowane do `main`, czeka na deploy ROBOCZA. |
