...
| AI-BALANS-STEP6-Q1 | 2026-08-06 | Kara score 2. zwiadowca −80 pkt w `chooseCityProduction` | **ECHO ZAPISANA** · czeka Autobot wdrożenia | `docs/decyzje/AI-BALANS-STEP6-Q1.md` · paczka ABC 2026-08-06 |
...
| R-KAMIEN-RELIEF-FOLLOWUP-Q1 | 2026-08-06 | Whitelist reliefu: legacy `kopalnia` + reguła wszystkich kopalń | **SCALONE** (Eval PASS-WITH-NOTES) · commit czeka | `docs/decyzje/R-KAMIEN-RELIEF-FOLLOWUP-Q1.md` · A + reguła „teraz i przyszłe" · `gra/src/game/relief-preserving-improvements.ts` |
| MAP-UX-CLUSTER-LABEL-Q1 | 2026-08-06 | Etykiety stolica (civ + marker) vs MP (nazwa + dopisek) | **SCALONE** (Eval PASS-WITH-NOTES) · commit czeka · otwarte MAP-UX-CAPITAL-MP-SCOPE-Q1 (korona dla MP) | `docs/decyzje/MAP-UX-CLUSTER-LABEL-Q1.md` · B+C |
| R-WIARYGODNOSC-S9-Q1 | 2026-08-06 | Pełna paczka strojenia liczb §9 (JSON + testy) | **TABELA GOTOWA** (Eval PASS-WITH-NOTES, 2 błędy poprawione) · czeka OK Macieja przed kodem | `docs/decyzje/R-WIARYGODNOSC-S9-TABELA-LICZB.md` |
| R-DESIGN-PANEL-MIASTA-V2-Q1 | 2026-08-06 | Pilne zlecenie Design klatek v2; kod nie zamrożony | **FAIL Evaluatora** (opis niezgodny ze stanem HEAD) · powtórka Operatora w toku | `docs/decyzje/R-DESIGN-PANEL-MIASTA-V2-Q1.md` · C |
| R-OBRONA-MIASTA-MP-Q1 | 2026-08-06 | Obrona bez murów: rozbicie bonusów w preBattle (mechanika bez zmian) | **FAIL Evaluatora** (panel myli się względem realnej walki) · powtórka Operatora w toku | `docs/decyzje/R-OBRONA-MIASTA-MP.md` §ECHO · A |
...
| R-OBRONA-MIASTA-MP | 2026-07-26 | „nie wiem też, dlaczego nagle przeciwnicy mają jakieś niewiarygodne bonusy w obronie miasta, jeżeli nawet nie ma tam muru, zwłaszcza kiedy atakuje państwa miasta. Coś tu jest nie tak." | **ECHO ZAPISANA** · `R-OBRONA-MIASTA-MP-Q1=A` · czeka Autobot wdrożenia | Audyt: brak buga podwójnego mnożnika; A = rozbicie preBattle · `docs/decyzje/R-OBRONA-MIASTA-MP.md` |
