...
| `P-DYPLO-ZELAZO-BRAK-WOJNY-WYMUSZONEJ-Q1` | **DISPATCHOWANE** | Nowy `forced-war-iron.ts`, parametry 1:1 z Brązu. |
| `P-STADNINA-LAS-NIEROZSTRZYGNIETE-Q1` | **DISPATCHOWANE** | Stadnina dołącza do grupy budynków surowcowych (wzorem Glinianki) — budowalna w lesie, przetrwa usunięcie lasu. Precyzyjna odpowiedź właściciela (nie proste A/B) wklejona dosłownie w dispatch. |
