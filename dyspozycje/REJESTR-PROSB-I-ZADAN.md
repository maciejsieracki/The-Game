...
| AI-BALANS-STEP5 | 2026-08-06 | bonus_produkcja → realna Praca major AI | **W TOKU** `cursor/ai-balans-step5-63a1` | P0-1 formalizacja · test step5 · `AI-BALANS-STEP5.md` |
...
| R-ESC-PELNY-EKRAN | 2026-07-26 | Escape: najpierw zamknij panel, potem pełny ekran | **ZDEPLOYOWANE** FALA 252 `bbff9996` (+ F251 baza) · Q1=A | `escapeOverlayStack.ts` · tech/city/diplo/wiki/build + science-picker/army-list/save-load (F252) |
