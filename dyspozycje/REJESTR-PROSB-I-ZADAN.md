...
| `P-TECHNOLOGIA-POPUP-KARTA-ODKRYCIA-Q1` | `ECHO=A ZAPISANE — RECON W TOKU` | ECHO A (Maciej, 2026-08-21): prototyp zaakceptowany, recon rozbieżności źródeł przed dalszym wdrożeniem — `docs/decyzje/P-TECHNOLOGIA-POPUP-KARTA-ODKRYCIA-Q1.md`. Branch: `autobot/P-TECHNOLOGIA-POPUP-KARTA-ODKRYCIA-Q1`. Recon dispatchowany 2026-08-21 (drugi raz — poprzedni recon byl przed migracja karty na `entityCards` w tej samej sesji, T3 `R-FEATURE-KARTY-ENCYKLOPEDIA-CIVPEDIA-Q1`; trzeba sprawdzic rozbieznosci na NAJNOWSZYM kodzie). |
