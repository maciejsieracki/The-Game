...
| ID | Prośba | Status | Uwagi |
|---|---|---|---|
| `R-DYPLO-AI-WOJNA-Z-GRACZEM-PARZYSTOSC-Q1` | "Jeżeli jest parzysta ilość cywilizacji, to przeważnie one wypowiadają wojny [sobie nawzajem], a nie ma żadnej cywilizacji, która wypowiedziałaby wojnę graczowi... cywilizacja, która już wypowiedziała wojnę innej cywilizacji, [powinna mieć] pozwolenie na to, aby wypowiedziała wojnę graczowi." | **RECON W TOKU (subagent Explore w tle)** | Domain GAME, balans/AI. Hipoteza właściciela: parowanie AI-AI przy parzystej liczbie cywilizacji wyklucza gracza z bycia celem wojny. Recon sprawdza: czy gracz jest jawnie wykluczony z doboru celu wojny AI, czy jest limit "jedna wojna na cywilizację AI naraz" (co przy parzystej liczbie zużywa cały budżet wojny na inne AI), i czy AI w ogóle kiedykolwiek wypowiada wojnę graczowi. Dispatch po powrocie recon. |
