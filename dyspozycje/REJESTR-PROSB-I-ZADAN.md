...
| `R-UI-WYKONAJ-DECYZJA-OVERLAP-Q1` | `OPERATOR` | Zgłoszenie właściciela 2026-08-21 (2 zrzuty ekranu): pasek „N karta wymaga decyzji" nad przyciskiem „Zakończ turę" po wykonaniu blokującej decyzji znika, ale zostawia elementy które się nakładają — pusty, wyszarzony prostokąt „WYKONAJ" widoczny nawet po zniknięciu ostrzeżenia. Recon+fix dispatchowany. Punkt startowy: `gra/src/ui/bottomBarHud.ts::render()`. |
