...
| R-DYST-DREWNO | 2026-07-24 | Surowce jednostek: rekrutacja×5 + utrzymanie=baza (Drewno/Brąz/Żelazo) | **WDROŻONE (kod)** branch `cursor/unit-resource-costs-x5-63a1` · czeka deploy | Akceptacja Macieja 2026-08-06 · tabela `R-DYST-DREWNO-TABELE-AKCEPTACJA.md` · test unit-resource-upkeep 7/7 |
...
| R-DESIGN-PANEL-MIASTA | 2026-07-25 | Pigułka miasta na mapie — hover produkcji + ostrzeżenie surowców | **ZAPISANA** Q4=**B** · czeka `działaj` (bez makiety Design) | Q1B·Q2C·Q3A·Q4B · `docs/decyzje/R-DESIGN-PANEL-MIASTA-Q4.md` · always-on już w ROBOCZA |
...
| R-ESC-PELNY-EKRAN | 2026-07-26 | Escape: najpierw zamknij panel, potem pełny ekran | **ZAPISANA** R-ESC-PELNY-EKRAN-Q1=**A** · czeka `działaj` | Wspólny stos Escape jak tech tree. `docs/decyzje/R-ESC-PELNY-EKRAN-Q1.md`. |
