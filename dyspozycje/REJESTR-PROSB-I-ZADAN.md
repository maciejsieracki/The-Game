...
| R-AI-KUP-JEDN | 2026-07-24 | Audyt parytetu wykrył: AI NIE ma ścieżki „kup jednostkę za złoto" (`purchaseRecruitmentUnit` main.ts:2054-2092 zablokowane do `ownerId===0`; brak odpowiednika w `AICommand` ai.ts:95-101). AI tylko kolejkuje Pracą. | CZEKA-NA-DECYZJĘ | Zamierzone ograniczenie czy luka parytetu? Gracz może kupić jednostkę natychmiast za złoto, AI nie. Do decyzji Macieja. |
