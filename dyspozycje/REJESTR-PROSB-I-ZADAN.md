...
**Notatka 2026-08-06:** Cleanup rejestru vs FALA 248–253 (AutoBot Operator #14). Źródło prawdy deployu = **AKTUALNA FALA 253** (`b8704216`).
...
| AI-BALANS-STEP2 | 2026-08-05 | L3 pokój: score Wojownik −40 | **ZDEPLOYOWANE** FALA 246 `cbf529f3` | C.3 Ś2 · test 9/9 · `AI-BALANS-STEP2.md` |
| AI-BALANS-STEP3 | 2026-08-05 | L3 cuda throttle 3→2 | **ZDEPLOYOWANE** FALA 247 `540d2490` | `cuda_poziom3_throttle_tur` · `AI-BALANS-STEP3.md` |
| AI-BALANS-STEP4 | 2026-08-05 | L3 cuda prog 70→80 | **ZDEPLOYOWANE** FALA 248 `772bab7c` | `cuda_poziom3_prog_koszt_x` · `AI-BALANS-STEP4.md` |
...
| R-DESIGN-PANEL-MIASTA | **ZDEPLOYOWANE** FALA 251 `e594f018` | prototyp v1 + hover produkcji/ostrzeżenie surowców · `docs/decyzje/R-DESIGN-PANEL-MIASTA.md` |
...
| R-PIERWSZE-MIASTO | 2026-07-27 | Decyzja **B** (Maciej): pełna blokada — tylko „Załóż miasto", bez ruchu/innych akcji osadnika. Tylko gracz (AI: nie). | **ZDEPLOYOWANE** FALA 249 `097c5e5c` | `docs/decyzje/R-PIERWSZE-MIASTO.md` · `first-player-city.ts` · test `first-player-city-test.cjs` |
...
| R-OBRONA-MIASTA-MP | 2026-07-26 | Bonusy obrony miasta-państwa bez murów — audyt | **AUDYT ZAMKNIĘTY** · ABC rekomendowane | `docs/decyzje/R-OBRONA-MIASTA-MP.md` · brak buga podwójnego mnożnika |
| R-TEREN-BITWA-WERYF | 2026-07-26 | Bonusy terenu w bitwie ręcznej (las, wzgórza, rzeka) | **RAPORT GOTOWY** — 3 martwe mechaniki do decyzji | `R-TEREN-BITWA-WERYF-WYNIK` · Góry +75% / Δ Zasięg martwe |
| R-DYP-STOL-A | 2026-07-27 | AI inicjuje w audiencji + pełny koszyk traktatów | **ZAMKNIĘTE ABC** — kod CZĘŚCIOWO | B ~OK; C: koszyk tylko akcje 5/13 · `docs/decyzje/R-DYP-STOL-A.md` |
...
| R-OBRONA-MIASTA-MP | 2026-07-26 | „nie wiem też, dlaczego nagle przeciwnicy mają jakieś niewiarygodne bonusy w obronie miasta, jeżeli nawet nie ma tam muru, zwłaszcza kiedy atakuje państwa miasta. Coś tu jest nie tak." | **AUDYT ZAMKNIĘTY** · branch `cursor/audit-obrona-miasta-mp-63a1` | Werdykt: brak buga podwójnego mnożnika; `bonusWalka` NIE dla MP (TAK +5% major AI Trudny); główna „tajemnica” = garnizon +50% bez murów + milicja + roster dist≤1. Pełne rozbicie: `docs/decyzje/R-OBRONA-MIASTA-MP.md` · ABC rekomendowane (UX rozbicie preBattle). |
...
| R-RZEKI-KILLSWITCH-DIAG | 2026-08-01 | Eksperyment diagnozy: wyłączanie rzek stage 0–5 (izolacja wąskiego gardła) | **ODŁOŻONE** | Maciej 2026-08-01: gęstość rzek OK; wąskie gardło = Budowanie sceny (naprawione F248). Bramka stage 0 zostaje w kodzie. |
