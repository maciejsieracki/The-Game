...
| R-BARB-WOJNA | 2026-07-26 | „barbarzyńcy atakują pomimo tego, że nie podają wojny. Zwłaszcza, że atakują zwiadowców, których w ogóle nie powinni atakować" | **W DIAGNOZIE** (subagent Sonnet 5) | Do rozstrzygnięcia: czy barbarzyńcy w ogóle podlegają stanowi wojny (czy mają relację dyplomatyczną), oraz czy istnieje/istniała reguła wykluczająca jednostki zwiadowcze z celów ataku. |
