...
| R-DEFICYT-ZLOTA-KARA-Q1 | 2026-08-06 | Kara za deficyt Złota — analogia do głodu wojska (staty + atrycja HP) | PASS-WITH-NOTES, kod gotowy poza progiem (saldo tury zamiast Skarbca) — **poprawka R-DEFICYT-ZLOTA-TRIGGER-Q1=B w toku** | `docs/decyzje/R-DEFICYT-ZLOTA-KARA-Q1.md` · A+B |
