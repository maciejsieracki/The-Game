'use strict';
/**
 * zrzut-mapy.cjs — R-MAPA-ETYKIETA-STOLICY-NAZWA-MIASTA-Q1, ZYWY dowod w Chromium.
 *
...
(async () => {
  ...
  await page.screenshot({ path: path.join(HERE, 'mapa-obca-stolica-1600x1000.png') });
  await page.screenshot({
    path: path.join(HERE, 'mapa-obca-stolica-zblizenie.png'),
