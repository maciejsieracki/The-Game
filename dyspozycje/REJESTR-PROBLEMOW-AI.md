...
| **P-AI-014** | 2026-08-02 | MP/AI **nie budują budynków** — planner bez bramki tech/epoki → pusta kolejka (`Build blocked`) | **NAPRAWIONE (kod)** | `AITurnOpts.isProductionAllowed` + filtr w `chooseCityProduction`; main.ts woła `availableProduction`; testy T7D-j/k |
