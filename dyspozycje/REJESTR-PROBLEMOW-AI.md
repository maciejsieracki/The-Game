...
| **P-AI-014** | 2026-08-02 | **BUG-DYP-GIFT-WAR** — dar 50¤ od miasta-państwa widoczny i akceptowalny podczas wojny | **NAPRAWIONE (kod)** | `pruneInvalidNegotiations` po DOW; filtr UI + bramka Accept; `resolvePlayerAcceptsAiPending` + `isGift` |
