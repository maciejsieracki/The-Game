...
- 2026-07-09 · **f69d1b0bc13c97c83df019e8ceba6ee4** · stempel: ROBOCZA · f69d1b0b · **FPS domknięty (fog diff 41→1,9 ms · matrixAutoUpdate · cienie na żądanie · minimapa klik→kamera) + DEKOR mikrodekor łąk/równin + ZASADY-ZWIERZĄT E1–E5 (lama wzgórza/góry · koń poza food-gate · Nowy Świat koń · Trzoda · posiew lamy Inków · macierz miasta B)** ·
  Baza = kanon a1dce24d + prace sesji 2026-07-09 (commity lokalne na `main`; F9 baseline przed dekorem: FPS 57, fog 1,9 ms). Diff-fog + cienie na żądanie = **core mgły/renderera → test wzrokowy Macieja**. DEKOR/ZASADY: hash mapy nietknięty (regresja 55aaa07c). tsc=0 · smoke OK · vite-direct (bez prebuildu) · 9 plików + hub · verify OK · **AKTUALNA (test Macieja)**. Log optymalizacji: `dyspozycje/OPTYMALIZACJE-FPS-LOG.md`. Promocja do kanonu + push: po teście.
