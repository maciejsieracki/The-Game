 ...
 */
export const WALL_PANCERZ_FRACTION = 0.5;
 ...
 */
export const HILL_DEFENSE_MULT = 1.5;
 ...
 */
export const MOUNTAIN_DEFENSE_MULT = 1.75;
 ...
 */
export const MILITIA_STRENGTH_FRACTION = 0.5;
...
export interface SiegeUnit {
  ...
  /** Attack stat -- hit chance. */
  Atak: number;

  /** Defence stat -- dodge side of hit chance. Wall/terrain bonuses add here. */
  Obrona: number;

  /** Charge bonus added to damage in round 1 of melee. */
  Uderzenie: number;

  /** Armour -- reduces incoming damage. Part of the wall bonus hardens this. */
  Pancerz: number;

  /** Armour penetration -- bypasses Pancerz in the damage formula. */
  Przebicie: number;
...
/** Stone-age Warrior baseline (data/units.json "Wojownik") used to scale militia. */
