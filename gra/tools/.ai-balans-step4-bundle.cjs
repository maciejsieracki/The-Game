...
// tools/.ai-balans-step4-entry.ts
var ai_balans_step4_entry_exports = {};
__export(ai_balans_step4_entry_exports, {
  decideAiWonderBuild: () => decideAiWonderBuild,
  loadAiWonderParams: () => loadAiWonderParams
});
module.exports = __toCommonJS(ai_balans_step4_entry_exports);
...
function loadAiWonderParams(data, poziom = 2) {
  const n = poziom;
  return {
...
function decideAiWonderBuild(turn, ownerId, hasWonderInProgress, cityCandidates, buildableWonders, difficulty) {
