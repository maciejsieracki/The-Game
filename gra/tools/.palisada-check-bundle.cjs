...
// tools/.palisada-check-entry.ts
var palisada_check_entry_exports = {};
__export(palisada_check_entry_exports, {
  availableProduction: () => availableProduction,
  eraBuildingCatalog: () => eraBuildingCatalog
});
module.exports = __toCommonJS(palisada_check_entry_exports);
