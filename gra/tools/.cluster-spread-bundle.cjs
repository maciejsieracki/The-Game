...
// tools/.cluster-spread-entry.ts
var cluster_spread_entry_exports = {};
__export(cluster_spread_entry_exports, {
  buildClusterStartPlan: () => buildClusterStartPlan,
  capitalMinSeparationForMap: () => capitalMinSeparationForMap,
  clusterBodyBufferRadius: () => clusterBodyBufferRadius,
  clusterBodySeparationForMap: () => clusterBodySeparationForMap,
  clusterCenterQuadrantSpread: () => clusterCenterQuadrantSpread,
  generateMap: () => generateMap,
  hexDistanceAxial: () => hexDistanceAxial,
  landQuadrantIndex: () => landQuadrantIndex,
  minimumSpreadQuartersRequired: () => minimumSpreadQuartersRequired,
  setRiverGenPhaseOverride: () => setRiverGenPhaseOverride
});
module.exports = __toCommonJS(cluster_spread_entry_exports);
