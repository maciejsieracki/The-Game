...
// tools/.battle-roster-entry.ts
var battle_roster_entry_exports = {};
__export(battle_roster_entry_exports, {
...
module.exports = __toCommonJS(battle_roster_entry_exports);
