...
// tools/.river-loop-entry.ts
var river_loop_entry_exports = {};
__export(river_loop_entry_exports, {
  generateMap: () => generateMap,
  riverPathHasRevisitedHex: () => riverPathHasRevisitedHex,
  sanitizeRiverPath: () => sanitizeRiverPath
});
module.exports = __toCommonJS(river_loop_entry_exports);
...
function riverPathHasRevisitedHex(path) {
