...
// tools/.river-density-entry.ts
var river_density_entry_exports = {};
__export(river_density_entry_exports, {
  generateMap: () => generateMap,
  resolveWorldGenNumbers: () => resolveWorldGenNumbers
});
module.exports = __toCommonJS(river_density_entry_exports);
