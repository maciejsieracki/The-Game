...
// tools/.relief-grid-entry.ts
var relief_grid_entry_exports = {};
__export(relief_grid_entry_exports, {
  copperCoverageCellSize: () => copperCoverageCellSize,
  copperGridCoverageRatio: () => copperGridCoverageRatio,
  generateMap: () => generateMap,
  groupLandMassKeys: () => groupLandMassKeys,
  ironCoverageCellSize: () => ironCoverageCellSize,
  ironGridCoverageRatio: () => ironGridCoverageRatio
});
module.exports = __toCommonJS(relief_grid_entry_exports);
...
function ironGridCoverageRatio(massLandKeys, hexes, cellSize, tier = "medium") {
...
function copperGridCoverageRatio(massLandKeys, hexes, cellSize, tier = "medium") {
  const massSet = new Set(massLandKeys);
  const minLand = minLandHexesForReliefCell(cellSize);
  let need = 0;
  let hit = 0;
