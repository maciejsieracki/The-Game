...
// tools/.ai-recruit-upkeep-gate-entry.ts
var ai_recruit_upkeep_gate_entry_exports = {};
__export(ai_recruit_upkeep_gate_entry_exports, {
  UNIT_RECRUIT_UPKEEP_RESERVE_TURNS: () => UNIT_RECRUIT_UPKEEP_RESERVE_TURNS,
  canAffordBuildingStock: () => canAffordBuildingStock,
  canAffordUnitRecruitFull: () => canAffordUnitRecruitFull,
  canAffordUnitRecruitUpkeepReserve: () => canAffordUnitRecruitUpkeepReserve,
  ownerResourceStockAll: () => ownerResourceStockAll,
  unitRecruitFullStockCost: () => unitRecruitFullStockCost,
  unitRecruitUpkeepReserve: () => unitRecruitUpkeepReserve,
  unitResourceUpkeep: () => unitResourceUpkeep,
  unitStockCost: () => unitStockCost
});
module.exports = __toCommonJS(ai_recruit_upkeep_gate_entry_exports);
...
function canAffordUnitRecruitUpkeepReserve(pool, unitDef, turns = UNIT_RECRUIT_UPKEEP_RESERVE_TURNS) {
  return canAffordBuildingStock(pool, unitRecruitUpkeepReserve(unitDef, turns));
}
function unitRecruitFullStockCost(unitDef, turns = UNIT_RECRUIT_UPKEEP_RESERVE_TURNS) {
  const out = { ...unitStockCost(unitDef) };
  addResourceCosts(out, unitRecruitUpkeepReserve(unitDef, turns));
  return out;
}
function canAffordUnitRecruitFull(pool, unitDef, turns = UNIT_RECRUIT_UPKEEP_RESERVE_TURNS) {
