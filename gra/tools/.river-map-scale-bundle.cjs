...
// tools/.river-map-scale-entry.ts
var river_map_scale_entry_exports = {};
__export(river_map_scale_entry_exports, {
  generateMap: () => generateMap,
  pathEndsAtSea: () => pathEndsAtSea,
  resolveRiverMapParams: () => resolveRiverMapParams
});
module.exports = __toCommonJS(river_map_scale_entry_exports);
...
function enforceMaxDryLowlandPatches(massSet, gridCtx) {
  ...
  fillDryLowlandPatches(massSet, gridCtx, Math.ceil(maxHex / 2), 5);
