...
eq(D.diplomacyHandelSurowiecCenaJednostkowa('drewno'), 0.2, 'drewno 0.2 PN/szt. po obniżce ×5');
eq(D.diplomacyHandelSurowiecCenaJednostkowa('glina'), 0.4, 'glina 0.4 PN/szt. po obniżce ×5');
eq(D.diplomacyHandelSurowiecCenaJednostkowa('kamien'), 0.6, 'kamien 0.6 PN/szt. po obniżce ×5');
eq(D.diplomacyHandelSurowiecCenaJednostkowa('ruda'), 1, 'ruda miedzi 1 PN/szt. po obniżce ×5');
eq(D.diplomacyHandelSurowiecCenaJednostkowa('ruda_zelaza'), 2, 'ruda_zelaza 2 PN/szt. po obniżce ×5');
eq(D.diplomacyHandelSurowiecCenaJednostkowa('cegla'), 1, 'cegla 1 PN/szt. po obniżce ×5');
eq(D.diplomacyHandelSurowiecCenaJednostkowa('sol'), 0.4, 'sol 0.4 PN/szt. po obniżce ×5');
eq(D.diplomacyHandelSurowiecCenaJednostkowa('kon'), 1, 'kon 1 PN/szt. po obniżce ×5');
eq(D.diplomacyHandelSurowiecCenaJednostkowa('ceramika'), 1, 'ceramika 1 PN/szt. po obniżce ×5');
eq(D.diplomacyHandelSurowiecCenaJednostkowa('braz'), 3, 'braz 3 PN/szt. po obniżce ×5');
eq(D.diplomacyHandelSurowiecCenaJednostkowa('zelazo'), 4, 'zelazo 4 PN/szt. po obniżce ×5');
eq(D.diplomacyHandelSurowiecCenaJednostkowa('stal'), 5, 'stal 5 PN/szt. po obniżce ×5');
eq(D.diplomacyHandelSurowiecCenaJednostkowa('zloto'), 10, 'zloto-surowiec 10 PN/szt. po obniżce ×5');
eq(D.diplomacyHandelSurowiecCenaJednostkowa('wegiel'), 4, 'wegiel 4 PN/szt. po obniżce ×5');
eq(D.diplomacyPnSurowiecIlosc('drewno', 1), 2, '1 pakiet drewno = 2 PN (1×10×0.2)');
eq(D.diplomacyPnSurowiecIlosc('ruda_zelaza', 2), 40, '2 pakiety ruda_zelaza = 40 PN (2×10×2)');
eq(D.diplomacyPnSurowiecIlosc('stal', 1), 50, '1 pakiet stal = 50 PN (1×10×5)');
eq(D.diplomacyPnSurowiecIlosc('zloto', 1), 100, '1 pakiet zloto = 100 PN (1×10×10)');
eq(D.diplomacyPnSurowiecIlosc('wegiel', 1), 40, '1 pakiet wegiel = 40 PN (1×10×4)');
