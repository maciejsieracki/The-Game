...
// tools/.alliance-war-obligation-entry.ts
var alliance_war_obligation_entry_exports = {};
__export(alliance_war_obligation_entry_exports, {
  aiHonorsAllianceWarObligation: () => aiHonorsAllianceWarObligation,
  shouldHonorAllianceWarObligation: () => shouldHonorAllianceWarObligation
});
module.exports = __toCommonJS(alliance_war_obligation_entry_exports);

// src/game/alliance-war-obligation.ts
var DEFAULT_MIN_RATIO_HONOR = 0.55;
var DEFAULT_MIN_RATIO_HONOR_PEACEFUL = 0.75;
var DEFAULT_MAX_WARS_BEFORE_REFUSE = 1;
var DEFAULT_MIN_TRUST_HONOR = 20;
function shouldHonorAllianceWarObligation(inp) {
  ...
  if (inp.trustToRequestingAlly !== void 0) {
...
// src/game/ai.ts
function aiHonorsAllianceWarObligation(allyId, mustDeclareWarOn, attackerId, victimId, ctx) {
  if (!ctx) return true;
