...
// tools/.pangea-river-interior-entry.ts
var pangea_river_interior_entry_exports = {};
__export(pangea_river_interior_entry_exports, {
  TerenBazowy: () => TerenBazowy,
  buildSeaDistanceField: () => buildSeaDistanceField,
  generujSwiat: () => generujSwiat
});
module.exports = __toCommonJS(pangea_river_interior_entry_exports);
