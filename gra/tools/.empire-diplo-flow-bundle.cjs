...
// tools/.empire-diplo-flow-entry.ts
var empire_diplo_flow_entry_exports = {};
__export(empire_diplo_flow_entry_exports, {
  empireDiploResourceFlowPerTurn: () => empireDiploResourceFlowPerTurn
});
module.exports = __toCommonJS(empire_diplo_flow_entry_exports);
...
// src/game/empire-diplo-resource-flow.ts
function empireDiploResourceFlowPerTurn(activeDeals, ownerId, pakietWielkosc = diplomacyHandelSurowcePakietWielkosc()) {
  const flows = {};
...
0 && (module.exports = {
  empireDiploResourceFlowPerTurn
});
