...
// tools/._tmp-dry-nearest-entry.ts
var tmp_dry_nearest_entry_exports = {};
__export(tmp_dry_nearest_entry_exports, {
  TerenBazowy: () => TerenBazowy,
  buildSeaDistanceField: () => buildSeaDistanceField,
  generateMap: () => generateMap
});
module.exports = __toCommonJS(tmp_dry_nearest_entry_exports);
