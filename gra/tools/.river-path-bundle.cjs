...
// tools/.river-path-entry.ts
var river_path_entry_exports = {};
__export(river_path_entry_exports, {
  assertRiverPathAdjacent: () => assertRiverPathAdjacent,
  generateMap: () => generateMap
});
module.exports = __toCommonJS(river_path_entry_exports);
