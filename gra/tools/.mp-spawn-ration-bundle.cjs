...
// tools/.mp-spawn-ration-entry.ts
var mp_spawn_ration_entry_exports = {};
__export(mp_spawn_ration_entry_exports, {
  DEFAULT_POZIOM_RACJI: () => DEFAULT_POZIOM_RACJI,
  DEFAULT_PROCENT_ROZWOJ: () => DEFAULT_PROCENT_ROZWOJ,
  foundCityAt: () => foundCityAt,
  generateMap: () => generateMap,
  getCityRationLevel: () => getCityRationLevel,
  migrateProcentRozwojToPoziomRacji: () => migrateProcentRozwojToPoziomRacji
});
module.exports = __toCommonJS(mp_spawn_ration_entry_exports);
