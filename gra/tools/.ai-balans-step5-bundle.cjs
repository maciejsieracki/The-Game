...
// tools/.ai-balans-step5-entry.ts
var ai_balans_step5_entry_exports = {};
__export(ai_balans_step5_entry_exports, {
  difficultyProductionMultiplier: () => difficultyProductionMultiplier,
  loadDifficultyParams: () => loadDifficultyParams,
  pracaImperialPoolGain: () => pracaImperialPoolGain,
  qualifiesForMajorAiDifficultyBonus: () => qualifiesForMajorAiDifficultyBonus
});
module.exports = __toCommonJS(ai_balans_step5_entry_exports);
...
function pracaImperialPoolGain(split, queueEmpty) {
...
// src/game/ai-difficulty-bonus.ts
function qualifiesForMajorAiDifficultyBonus(ownerId, isCityState) {
  return ownerId > 0 && !isBarbarian(ownerId) && !isCityState;
}
function difficultyProductionMultiplier(bonusProdukcja) {
