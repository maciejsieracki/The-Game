...
const routesA = TR.refreshTradeRoutes([p1, f1], [], map, built, NO_WAR);
...
const routesE_war = TR.refreshTradeRoutes([p1, f1], routesA, map, built, AT_WAR_0_1);
...
const routesF_peace = TR.refreshTradeRoutes([p1, f1], routesE_war, map, built, NO_WAR);
...
const routesF2 = TR.refreshTradeRoutes([p1, f1], routesF_peace, map, builtNoTargowisko, NO_WAR);
