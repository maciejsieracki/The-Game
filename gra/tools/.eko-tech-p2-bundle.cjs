...
// tools/.eko-tech-p2-entry.ts
var eko_tech_p2_entry_exports = {};
__export(eko_tech_p2_entry_exports, {
  Nakladka: () => Nakladka,
...
module.exports = __toCommonJS(eko_tech_p2_entry_exports);
...
function depositAllowsPlayerImprovement(key, hex) {
  ...
  switch (key) {
    ...
    case "kopalnia_miedzi":
      return zloze === "miedz" || nakladka === "zloze_rudy" /* ZlozeRudy */ || zloze === "ruda";
