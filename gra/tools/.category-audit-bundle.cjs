...
// tools/.category-audit-entry.ts
var category_audit_entry_exports = {};
__export(category_audit_entry_exports, {
  categoryOf: () => categoryOf
});
module.exports = __toCommonJS(category_audit_entry_exports);
