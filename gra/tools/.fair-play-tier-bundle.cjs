...
// tools/.fair-play-tier-entry.ts
var fair_play_tier_entry_exports = {};
__export(fair_play_tier_entry_exports, {
  ...
  waterCoverageCellSize: () => waterCoverageCellSize
});
module.exports = __toCommonJS(fair_play_tier_entry_exports);
