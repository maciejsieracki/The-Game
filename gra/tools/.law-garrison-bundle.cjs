...
// ../../../gra/tools/.law-garrison-entry.ts
var law_garrison_entry_exports = {};
__export(law_garrison_entry_exports, {
  countLawGarrisonOnCityHex: () => countLawGarrisonOnCityHex
});
module.exports = __toCommonJS(law_garrison_entry_exports);
...
// ../../../gra/src/game/armyMerge.ts
function countLawGarrisonOnCityHex(units, cityQ, cityR, ownerId) {
  return units.filter(
    (u) => u.ownerId === ownerId && u.q === cityQ && u.r === cityR && !u.oblegaCityId
  ).length;
}
