...
// tools/.korupcja-entry.ts
var korupcja_entry_exports = {};
__export(korupcja_entry_exports, {
  Nakladka: () => Nakladka,
  TerenBazowy: () => TerenBazowy,
  cityYieldPerTurn: () => cityYieldPerTurn,
  corruptionBuildingReduction: () => corruptionBuildingReduction,
  corruptionRate: () => corruptionRate,
  loadEconParams: () => loadEconParams
});
module.exports = __toCommonJS(korupcja_entry_exports);
