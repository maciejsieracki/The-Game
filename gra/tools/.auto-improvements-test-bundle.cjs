...
// tools/.auto-improvements-test-entry.ts
var auto_improvements_test_entry_exports = {};
__export(auto_improvements_test_entry_exports, {
  AUTO_ULEPSZENIA_PRACA_RESERVE: () => AUTO_ULEPSZENIA_PRACA_RESERVE,
  pickAutoImprovements: () => pickAutoImprovements,
  prioritiesForUlepszeniaFocus: () => prioritiesForUlepszeniaFocus
});
module.exports = __toCommonJS(auto_improvements_test_entry_exports);
...
var AUTO_ULEPSZENIA_PRACA_RESERVE = 30;
