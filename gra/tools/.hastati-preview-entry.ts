/**
 * .hastati-preview-entry.ts — entry TYLKO do podgladu porownawczego
 * (dyspozycje/PODGLAD-HASTATI-OPUS5.html). Nie jest czescia gry.
 *
 ...
 *   const js=e.buildSync({entryPoints:['tools/.hastati-preview-entry.ts'],
 *     bundle:true,platform:'browser',format:'iife',target:'es2020',
 *     minify:true,write:false}).outputFiles[0].text;
 *   const p='../dyspozycje/PODGLAD-HASTATI-OPUS5.html';
...
import { buildHastati } from '../src/render/hastati-falangita';
...
panels.push(makePanel(canvasA, buildHastati));
panels.push(makePanel(canvasB, buildHastatiOpus5));
