'use strict';
/**
 * capture-palisada-preview.cjs — PNG podglądu palisady (Three.js via statyczny HTML).
...
const SHOTS = [
  { file: 'miasto-kamien-palisada.png', kind: 'kamien', focus: 'kamien' },
  { file: 'miasto-braz-palisada.png', kind: 'braz', focus: 'braz' },
  { file: 'porownanie-obok.png', kind: 'both', overview: true },
];
