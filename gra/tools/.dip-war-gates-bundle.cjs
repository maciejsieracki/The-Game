...
// tools/.dip-war-gates-entry.ts
var dip_war_gates_entry_exports = {};
__export(dip_war_gates_entry_exports, {
  decideAIDiplomacy: () => decideAIDiplomacy,
  isCurrencyProposalForbiddenDuringWar: () => isCurrencyProposalForbiddenDuringWar,
  isNapBlockingWarDeclaration: () => isNapBlockingWarDeclaration,
  isPeaceCurrencyAction: () => isPeaceCurrencyAction,
  payloadHasCurrencyPayment: () => payloadHasCurrencyPayment,
...
module.exports = __toCommonJS(dip_war_gates_entry_exports);
...
function isNapBlockingWarDeclaration(hasActiveNapTreaty) {
