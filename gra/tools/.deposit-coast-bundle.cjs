...
// tools/.deposit-coast-entry.ts
var deposit_coast_entry_exports = {};
__export(deposit_coast_entry_exports, {
  Nakladka: () => Nakladka,
  TerenBazowy: () => TerenBazowy,
  countDepositsOnWater: () => countDepositsOnWater,
  generateMap: () => generateMap,
  generujSwiat: () => generujSwiat
});
module.exports = __toCommonJS(deposit_coast_entry_exports);
...
function countDepositsOnWater(hexes) {
  let n = 0;
  for (const hex of Object.values(hexes)) {
    if (hex.terenBazowy !== "morze" /* Morze */ && hex.terenBazowy !== "wybrzeze" /* Wybrzeze */) continue;
    if (hex.nakladka !== "brak" /* Brak */ || hex.zloze) n++;
  }
  return n;
}
