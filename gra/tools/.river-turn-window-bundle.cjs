...
// tools/.river-turn-window-entry.ts
var river_turn_window_entry_exports = {};
__export(river_turn_window_entry_exports, {
  MAIN_RIVER_MIN_PATH_SEP: () => MAIN_RIVER_MIN_PATH_SEP,
  RIVER_TURN_WINDOW_HEX: () => RIVER_TURN_WINDOW_HEX,
  RIVER_TURN_WINDOW_MAX_SUM: () => RIVER_TURN_WINDOW_MAX_SUM,
  generateMap: () => generateMap,
  nearestRiverHexDistance: () => nearestRiverHexDistance,
  riverGrowStepPassesSep: () => riverGrowStepPassesSep,
  riverPathHasSharpUTurn: () => riverPathHasSharpUTurn,
  riverPathViolatesTurnWindow: () => riverPathViolatesTurnWindow
});
module.exports = __toCommonJS(river_turn_window_entry_exports);
