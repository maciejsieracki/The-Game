...
// tools/.map-gen-profile-entry.ts
var map_gen_profile_entry_exports = {};
__export(map_gen_profile_entry_exports, {
  generujSwiat: () => generujSwiat,
  resolveRiverMapParams: () => resolveRiverMapParams,
  rozmiarToDims: () => rozmiarToDims
});
module.exports = __toCommonJS(map_gen_profile_entry_exports);
