...
// tools/.stranded-land-entry.ts
var stranded_land_entry_exports = {};
__export(stranded_land_entry_exports, {
  TerenBazowy: () => TerenBazowy,
  countOpenOceanLandSpecks: () => countOpenOceanLandSpecks,
  generateMap: () => generateMap
});
module.exports = __toCommonJS(stranded_land_entry_exports);
...
function countOpenOceanLandSpecks(hexes) {
  let n = 0;
  for (const hex of Object.values(hexes)) {
    if (hex.terenBazowy === "morze" /* Morze */ || hex.terenBazowy === "wybrzeze" /* Wybrzeze */) {
      continue;
