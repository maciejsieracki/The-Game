...
// tools/.prawo-siatka-v2-entry.ts
var prawo_siatka_v2_entry_exports = {};
__export(prawo_siatka_v2_entry_exports, {
  computeLawBreakdown: () => computeLawBreakdown
});
module.exports = __toCommonJS(prawo_siatka_v2_entry_exports);
