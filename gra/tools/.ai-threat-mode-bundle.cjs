...
// tools/.ai-threat-mode-entry.ts
var ai_threat_mode_entry_exports = {};
__export(ai_threat_mode_entry_exports, {
  AI_THREAT_RANGE_DEFAULT: () => AI_THREAT_RANGE_DEFAULT,
  aiThreatMajorUnitScores: () => aiThreatMajorUnitScores,
  aiThreatPrioritizeWalls: () => aiThreatPrioritizeWalls,
  aiThreatWallProductionScore: () => aiThreatWallProductionScore,
  chooseAIResearch: () => chooseAIResearch,
  chooseCityProduction: () => chooseCityProduction,
  hexDistance: () => hexDistance,
  loadDifficultyParams: () => loadDifficultyParams
});
module.exports = __toCommonJS(ai_threat_mode_entry_exports);
