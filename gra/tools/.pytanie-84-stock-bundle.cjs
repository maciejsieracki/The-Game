...
// tools/.pytanie-84-stock-entry.ts
var pytanie_84_stock_entry_exports = {};
__export(pytanie_84_stock_entry_exports, {
  EMPIRE_STOCK_RESOURCE_KEYS: () => EMPIRE_STOCK_RESOURCE_KEYS,
  MOUNT_UNIT_HORSE_STOCK_COST: () => MOUNT_UNIT_HORSE_STOCK_COST,
  STOCK_RESOURCE_LABEL: () => STOCK_RESOURCE_LABEL,
  territoryResourceYieldForImprovement: () => territoryResourceYieldForImprovement,
  unitStockCost: () => unitStockCost
});
module.exports = __toCommonJS(pytanie_84_stock_entry_exports);
...
var EMPIRE_STOCK_RESOURCE_KEYS = [
  "drewno",
  "kamien",
  "glina",
  "ruda",
