...
// tools/.earth-template-entry.ts
var earth_template_entry_exports = {};
__export(earth_template_entry_exports, {
  countLandSeaHexes: () => countLandSeaHexes,
  earthNorthOceanRows: () => earthNorthOceanRows,
  earthSouthOceanRows: () => earthSouthOceanRows,
  earthTemplateLandAt: () => earthTemplateLandAt,
  findInlandWaterHexes: () => findInlandWaterHexes,
  generateMap: () => generateMap,
  generujSwiat: () => generujSwiat,
  repairRiverPathAdjacency: () => repairRiverPathAdjacency
});
module.exports = __toCommonJS(earth_template_entry_exports);
