...
const recruitSlow = advanceRecruitmentGated(recruitStart, { population: 10, manpower: 10 }, 2, 1, true, options('grecy'));
...
const recruitBurst = advanceRecruitmentGated(recruitSlow.prod, { population: 10, manpower: 10 }, 2, 1, true, options('grecy'));
...
for (const civ of civs) {
  ...
  advanceRecruitmentGated(recruitStart, { population: 10, manpower: 10 }, 2, 1, true, neutral);
