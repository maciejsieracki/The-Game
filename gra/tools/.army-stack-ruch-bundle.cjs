...
// tools/.army-stack-ruch-entry.ts
var army_stack_ruch_entry_exports = {};
__export(army_stack_ruch_entry_exports, {
  deductStackRuchLeft: () => deductStackRuchLeft,
  stackRuchLeft: () => stackRuchLeft,
  syncStackRuchLeft: () => syncStackRuchLeft,
  unitWithStackRuch: () => unitWithStackRuch
});
module.exports = __toCommonJS(army_stack_ruch_entry_exports);
...
function deductStackRuchLeft(stack, cost) {
  syncStackRuchLeft(stack, Math.max(0, stackRuchLeft(stack) - cost));
}
function unitWithStackRuch(unit, stack) {
