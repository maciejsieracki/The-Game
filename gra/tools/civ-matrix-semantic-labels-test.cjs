...
equal(statusCounts.REAL_GAMEPLAY, 765, '51 proven gameplay parameters cover 15 profiles (population/AI/dip_handlowosc_archetyp base 14 + 37 Walka/Oblezenie fields wired R-CYWILIZACJE-MACIERZ-WALKA-10GRUP-Q1-20260925 + R-CYWILIZACJE-MACIERZ-WALKA-15-ZERO-POLA-Q1-20260925)');
...
equal(statusCounts.UNWIRED, 420, '28 unresolved parameters remain visibly unwired after population/Walka/Oblezenie reclassification; the 4 former meta REFERENCE_ONLY parameters were removed from the matrix entirely (R-CYWILIZACJE-MACIERZ-META-REMOVE-Q1-20260922) and are absent from every status count, not reclassified as UNWIRED');
