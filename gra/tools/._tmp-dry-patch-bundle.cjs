...
// tools/._tmp-dry-patch-entry.ts
var tmp_dry_patch_entry_exports = {};
__export(tmp_dry_patch_entry_exports, {
...
module.exports = __toCommonJS(tmp_dry_patch_entry_exports);
