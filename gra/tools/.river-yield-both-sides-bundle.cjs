...
// tools/.river-yield-both-sides-entry.ts
var river_yield_both_sides_entry_exports = {};
__export(river_yield_both_sides_entry_exports, {
  Nakladka: () => Nakladka,
  TerenBazowy: () => TerenBazowy,
  generateMap: () => generateMap,
  tileYield: () => tileYield
});
module.exports = __toCommonJS(river_yield_both_sides_entry_exports);
