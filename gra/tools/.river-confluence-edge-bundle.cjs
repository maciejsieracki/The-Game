...
// tools/.river-confluence-edge-entry.ts
var river_confluence_edge_entry_exports = {};
__export(river_confluence_edge_entry_exports, {
  checkRiverEdgeContinuity: () => checkRiverEdgeContinuity,
  checkTributaryJunctions: () => checkTributaryJunctions,
  generujSwiat: () => generujSwiat
});
module.exports = __toCommonJS(river_confluence_edge_entry_exports);
...
function riverEdgeMarkedBoth(hexes, a, b) {
  const eA = neighborDirIndex(a.q, a.r, b.q, b.r);
  const eB = neighborDirIndex(b.q, b.r, a.q, a.r);
...
function checkRiverEdgeContinuity(paths, hexes) {
  let violations = 0;
  let firstFail = null;
