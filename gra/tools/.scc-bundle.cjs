...
// tools/.scc-entry.ts
var scc_entry_exports = {};
__export(scc_entry_exports, {
  civCultureLabelForKey: () => civCultureLabelForKey,
  sameCultureCircle: () => sameCultureCircle
});
module.exports = __toCommonJS(scc_entry_exports);
...
function civCultureLabelForKey(civKey) {
  if (!civKey?.trim()) return void 0;
