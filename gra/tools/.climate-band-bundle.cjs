...
// tools/.climate-band-entry.ts
var climate_band_entry_exports = {};
__export(climate_band_entry_exports, {
  TerenBazowy: () => TerenBazowy,
  applyClimateBandsToHexes: () => applyClimateBandsToHexes,
  climateBandAt: () => climateBandAt,
  enforceLatitudinalOceanBuffer: () => enforceLatitudinalOceanBuffer,
  generujSwiat: () => generujSwiat,
  isInLatitudinalOceanBuffer: () => isInLatitudinalOceanBuffer,
  latitudinalOceanBufferRows: () => latitudinalOceanBufferRows
});
module.exports = __toCommonJS(climate_band_entry_exports);
