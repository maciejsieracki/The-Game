...
// tools/.ai-balans-step2-entry.ts
var ai_balans_step2_entry_exports = {};
__export(ai_balans_step2_entry_exports, {
  AI_L3_PEACE_WARRIOR_SCORE_PENALTY: () => AI_L3_PEACE_WARRIOR_SCORE_PENALTY,
  applyL3PeaceWarriorPenalty: () => applyL3PeaceWarriorPenalty,
  chooseCityProduction: () => chooseCityProduction,
  loadDifficultyParams: () => loadDifficultyParams
});
module.exports = __toCommonJS(ai_balans_step2_entry_exports);
