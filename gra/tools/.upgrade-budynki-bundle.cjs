...
// tools/.upgrade-budynki-entry.ts
var upgrade_budynki_entry_exports = {};
__export(upgrade_budynki_entry_exports, {
  applyCompletedBuildingIds: () => applyCompletedBuildingIds,
  availableProduction: () => availableProduction,
  cityHasAmfiteatrLine: () => cityHasAmfiteatrLine,
  cityHasBibliotekaLine: () => cityHasBibliotekaLine,
  cityHasMurLine: () => cityHasMurLine,
  isBuildingSupersededByUpgrade: () => isBuildingSupersededByUpgrade,
  isBuildingSuppressedFromProduction: () => isBuildingSuppressedFromProduction,
  upgradeChainSteps: () => upgradeChainSteps,
  upgradeProductionDisplayName: () => upgradeProductionDisplayName
});
module.exports = __toCommonJS(upgrade_budynki_entry_exports);
