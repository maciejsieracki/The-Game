...
// tools/.ai-production-priority-entry.ts
var ai_production_priority_entry_exports = {};
__export(ai_production_priority_entry_exports, {
  aiPanelPriorityDelta: () => aiPanelPriorityDelta,
  aiProductionScoreBoosts: () => aiProductionScoreBoosts,
  chooseCityProduction: () => chooseCityProduction,
  loadDifficultyParams: () => loadDifficultyParams
});
module.exports = __toCommonJS(ai_production_priority_entry_exports);
