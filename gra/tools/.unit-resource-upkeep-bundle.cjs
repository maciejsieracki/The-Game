...
// tools/.unit-resource-upkeep-entry.ts
var unit_resource_upkeep_entry_exports = {};
__export(unit_resource_upkeep_entry_exports, {
  totalUnitResourceUpkeep: () => totalUnitResourceUpkeep,
  unitResourceUpkeep: () => unitResourceUpkeep,
  unitStockCost: () => unitStockCost
});
module.exports = __toCommonJS(unit_resource_upkeep_entry_exports);
