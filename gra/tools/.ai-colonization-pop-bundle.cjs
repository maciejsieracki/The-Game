...
// tools/.ai-colonization-pop-entry.ts
var ai_colonization_pop_entry_exports = {};
__export(ai_colonization_pop_entry_exports, {
  AI_COLONIZATION_SOURCE_MIN_POP: () => AI_COLONIZATION_SOURCE_MIN_POP,
  AI_COLONIZATION_SOURCE_MIN_POP_L3: () => AI_COLONIZATION_SOURCE_MIN_POP_L3,
  colonizationSourceMinPop: () => colonizationSourceMinPop,
  hasColonizationSource: () => hasColonizationSource,
  isLocalExpansionPhase: () => isLocalExpansionPhase,
  planCityFounding: () => planCityFounding
});
module.exports = __toCommonJS(ai_colonization_pop_entry_exports);
