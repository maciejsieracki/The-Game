...
// tools/.krok2-typecheck-entry.ts
var krok2_typecheck_entry_exports = {};
__export(krok2_typecheck_entry_exports, {
  advanceCityEconomy: () => advanceCityEconomy,
  cityRangeForPopulation: () => cityRangeForPopulation,
  cityWorkedTilesForEconomy: () => cityWorkedTilesForEconomy,
  workedTilesForCity: () => workedTilesForCity
});
module.exports = __toCommonJS(krok2_typecheck_entry_exports);
...
function cityRangeForPopulation(population) {
  ...
  const cap = miasto_params_default.zasieg_okolicy_max?.wartosc ?? 15;
