...
// tools/.map-attack-city-entry.ts
var map_attack_city_entry_exports = {};
__export(map_attack_city_entry_exports, {
  resolveEnemyCityClick: () => resolveEnemyCityClick
});
module.exports = __toCommonJS(map_attack_city_entry_exports);
