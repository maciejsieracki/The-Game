...
// tools/.population-growth-tempo-entry.ts
var population_growth_tempo_entry_exports = {};
__export(population_growth_tempo_entry_exports, {
  WZROST_LUDNOSCI_PACE: () => WZROST_LUDNOSCI_PACE,
...
module.exports = __toCommonJS(population_growth_tempo_entry_exports);
