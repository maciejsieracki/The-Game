...
// tools/.waluta-mennica-entry.ts
var waluta_mennica_entry_exports = {};
__export(waluta_mennica_entry_exports, {
  ...
  mnoznikHandelPieniadzForCiv: () => mnoznikHandelPieniadzForCiv,
  mnoznikHandelPieniadzForCivByDifficulty: () => mnoznikHandelPieniadzForCivByDifficulty
});
module.exports = __toCommonJS(waluta_mennica_entry_exports);
