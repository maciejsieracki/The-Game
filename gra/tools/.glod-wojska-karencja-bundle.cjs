...
// tools/.glod-wojska-karencja-entry.ts
var glod_wojska_karencja_entry_exports = {};
__export(glod_wojska_karencja_entry_exports, {
  ...
  getArmyStarvationCountdown: () => getArmyStarvationCountdown,
  isArmyStarving: () => isArmyStarving,
  loadUpkeepParams: () => loadUpkeepParams,
  militaryFoodConsumption: () => militaryFoodConsumption,
  unitFoodPerTurn: () => unitFoodPerTurn
});
module.exports = __toCommonJS(glod_wojska_karencja_entry_exports);
...
function advanceEmpireFood(econ, units, states, upkeep, params, foodTable = {}) {
  ...
  const spichlerzCapByOwner = /* @__PURE__ */ new Map();
...
function getArmyStarvationCountdown(ownerId, karencjaTur) {
