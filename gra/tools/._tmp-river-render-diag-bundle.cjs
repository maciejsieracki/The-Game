...
// tools/._tmp-river-render-diag-entry.ts
var tmp_river_render_diag_entry_exports = {};
__export(tmp_river_render_diag_entry_exports, {
  buildSeaDistanceField: () => buildSeaDistanceField,
  generateMap: () => generateMap,
  landRiverRenderPath: () => landRiverRenderPath
});
module.exports = __toCommonJS(tmp_river_render_diag_entry_exports);
