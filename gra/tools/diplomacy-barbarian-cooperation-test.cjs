...
const seaRaider = u('sea-raider-on-land', 2, 1, -1, { seaRaider: true, embarked: false });
const engaged = u('engaged', 2, 0, 2);
const helpers = M.collectBarbarianCooperationUnits(0, 0, 0, [near, edge, far, scout, garrison, seaRaider, engaged], deal, new Set(['engaged']));
...
ok(!M.isEligibleBarbarianCooperationUnit(seaRaider), 'rajder morski jest wykluczony także po zejściu na ląd');
