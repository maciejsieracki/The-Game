/**
 * build-braz-taran-preview.cjs — regeneracja podgladu porownawczego
 * dyspozycje/PODGLAD-BRAZ-TARAN.html (Taran KAMIEN/plozy vs Taran okuty BRAZ/kola).
 *
 ...
 *
 * Uruchamiac z katalogu gra/:   node tools/build-braz-taran-preview.cjs
 */
...
const ENTRY = path.join(ROOT, 'tools', '.braz-taran-preview-entry.ts');
const HTML = path.join(ROOT, '..', 'dyspozycje', 'PODGLAD-BRAZ-TARAN.html');
