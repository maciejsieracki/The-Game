...
// tools/.land-sea-entry.ts
var land_sea_entry_exports = {};
__export(land_sea_entry_exports, {
  countLandSeaHexes: () => countLandSeaHexes,
  defaultLandFractionForTyp: () => defaultLandFractionForTyp,
  generujSwiat: () => generujSwiat,
  resolveLandFraction: () => resolveLandFraction
});
module.exports = __toCommonJS(land_sea_entry_exports);
