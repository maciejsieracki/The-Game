...
// tools/.deposit-gate-entry.ts
var deposit_gate_entry_exports = {};
__export(deposit_gate_entry_exports, {
  Nakladka: () => Nakladka,
...
module.exports = __toCommonJS(deposit_gate_entry_exports);
...
function labelsForKopalniaMiedziOnHex(hex) {
  if (hex.zloze?.trim().toLowerCase() === "miedz" || hex.nakladka === "zloze_rudy" /* ZlozeRudy */) {
