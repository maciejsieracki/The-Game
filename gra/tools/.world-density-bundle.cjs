...
// tools/.world-density-entry.ts
var world_density_entry_exports = {};
__export(world_density_entry_exports, {
  DEFAULT_WORLD_DENSITY: () => DEFAULT_WORLD_DENSITY,
  Nakladka: () => Nakladka,
  TerenBazowy: () => TerenBazowy,
  generujSwiat: () => generujSwiat,
  mapGenResourceMult: () => mapGenResourceMult,
  resolveWorldGenNumbers: () => resolveWorldGenNumbers
});
module.exports = __toCommonJS(world_density_entry_exports);
