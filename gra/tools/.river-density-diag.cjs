...
// tools/.river-density-diag-e.ts
var river_density_diag_e_exports = {};
__export(river_density_diag_e_exports, {
  ...
  resolveRiverTraceForMap: () => resolveRiverTraceForMap,
  resolveWorldGenNumbers: () => resolveWorldGenNumbers,
  riverCoverageCellSize: () => riverCoverageCellSize,
  riverGridCoverageRatio: () => riverGridCoverageRatio,
  traceRiver: () => traceRiver
});
module.exports = __toCommonJS(river_density_diag_e_exports);
...
function riverCoverageCellSize(tier = "medium", w, h) {
