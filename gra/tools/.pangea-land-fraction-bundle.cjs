...
// tools/.pangea-land-fraction-entry.ts
var pangea_land_fraction_entry_exports = {};
__export(pangea_land_fraction_entry_exports, {
  TerenBazowy: () => TerenBazowy,
  countLandSeaHexes: () => countLandSeaHexes,
  generujSwiat: () => generujSwiat,
  groupLandMassKeys: () => groupLandMassKeys,
  measurePangeaAnnularCorridorHexes: () => measurePangeaAnnularCorridorHexes,
  resolveLandFraction: () => resolveLandFraction
});
module.exports = __toCommonJS(pangea_land_fraction_entry_exports);
...
function setRiverGenEnabledOverride(enabled) {
  _override = enabled;
}
