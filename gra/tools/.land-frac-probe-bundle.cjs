...
// tools/.land-frac-probe-entry.ts
var land_frac_probe_entry_exports = {};
__export(land_frac_probe_entry_exports, {
  countLandSeaHexes: () => countLandSeaHexes,
  generateMap: () => generateMap
});
module.exports = __toCommonJS(land_frac_probe_entry_exports);
