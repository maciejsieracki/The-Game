...
// tools/.river-sea-buffer-entry.ts
var river_sea_buffer_entry_exports = {};
__export(river_sea_buffer_entry_exports, {
  RIVER_MIN_INLAND_FROM_SEA: () => RIVER_MIN_INLAND_FROM_SEA,
