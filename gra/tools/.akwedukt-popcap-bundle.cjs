...
// tools/.akwedukt-popcap-entry.ts
var akwedukt_popcap_entry_exports = {};
__export(akwedukt_popcap_entry_exports, {
  populationGrowth: () => populationGrowth
});
module.exports = __toCommonJS(akwedukt_popcap_entry_exports);
