...
// tools/.dip-alliance-sim-entry.ts
var dip_alliance_sim_entry_exports = {};
__export(dip_alliance_sim_entry_exports, {
  ...
  diplomacyAllianceMinZaufanie: () => diplomacyAllianceMinZaufanie,
  diplomacyAllianceStrengthAdjust: () => diplomacyAllianceStrengthAdjust,
...
module.exports = __toCommonJS(dip_alliance_sim_entry_exports);
...
function diplomacyProgDarRelacja(params = _pnRelacja) {
...
function pnGiftAllowed(relacja) {
