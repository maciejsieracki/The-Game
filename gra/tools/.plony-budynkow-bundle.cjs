...
// tools/.plony-budynkow-entry.ts
var plony_budynkow_entry_exports = {};
__export(plony_budynkow_entry_exports, {
  advanceCityEconomy: () => advanceCityEconomy,
  buildEconParams: () => buildEconParams,
  buildingHappinessAtLevel: () => buildingHappinessAtLevel,
  buildingLevelForEpoch: () => buildingLevelForEpoch,
  buildingValue: () => buildingValue,
  canFoundCity: () => canFoundCity,
  cityBuildingEntriesFromBuiltIds: () => cityBuildingEntriesFromBuiltIds,
  cityYieldPerTurn: () => cityYieldPerTurn,
  foundCityAt: () => foundCityAt,
  generateMap: () => generateMap,
  sumBuildingHappiness: () => sumBuildingHappiness,
  sumBuildingHappinessFromBuiltIds: () => sumBuildingHappinessFromBuiltIds
});
module.exports = __toCommonJS(plony_budynkow_entry_exports);
...
function sumBuildingHappiness(cityBuildings) {
  let sum = 0;
...
function growRiverInlandBeforeDrainage(hexes, sq, sr, seaDist, openOceanDist, rand, inlandTargetLen, stepCap) {
  ...
  while (path.length < inlandTargetLen && path.length < stepCap) {
    ...
    const pick2 = candidates[pickIdx] ?? candidates[0];
