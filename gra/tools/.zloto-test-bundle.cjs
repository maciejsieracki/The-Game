...
// tools/.zloto-test-entry.ts
var zloto_test_entry_exports = {};
__export(zloto_test_entry_exports, {
  CITY_BUILDING_PREREQ: () => CITY_BUILDING_PREREQ,
  DEFAULT_HEIGHT: () => DEFAULT_HEIGHT,
  DEFAULT_WIDTH: () => DEFAULT_WIDTH,
  DEPOSIT_RULES: () => DEPOSIT_RULES,
  FAIR_PLAY_DEPOSIT_IDS: () => FAIR_PLAY_DEPOSIT_IDS,
  KOPALNIA_ZLOTA_KEY: () => KOPALNIA_ZLOTA_KEY,
  Nakladka: () => Nakladka,
  ...
  empireHasKopalniaZlota: () => empireHasKopalniaZlota,
  eraBuildingCatalog: () => eraBuildingCatalog,
  galleryTerrainEligible: () => galleryTerrainEligible,
...
function ownerHasZlotoStock(empireStock) {
...
function eraBuildingCatalog(data, unlockedTechs, ctx = {}) {
  ...
  for (const b of data.buildings) {
    ...
    const resourceOk = canAffordBuildingStock(ctx.empireResourceStock, stockCost) && buildingResourceGateMet(
      b,
      ctx.empireActiveResourceLabels,
      ctx.empireBuiltIds,
      ctx.empireResourceStock
  ...
  function qualifies(key, q, r) {
    ...
    switch (key) {
      ...
      case "irygacja":
        ...
        break;
      case "bydlo":
        terrainOk = FLAT_FARM.has(teren) && inPlayerTerritory(q, r) && isLivestockAllowed(playerCivArchetype, key, playerEra) && isLivestockUnlockedForPlacement(key, hex, empireUnlocks);
        break;
      case "owce":
        ...
        break;
      case "lama":
        terrainOk = teren !== "pustynia" /* Pustynia */ && (TERRAIN_ALLOW.lama?.has(teren) ?? false) && inPlayerTerritory(q, r) && isLivestockAllowed(playerCivArchetype, key, playerEra) && isLivestockUnlockedForPlacement(key, hex, empireUnlocks);
        break;
      case "stadnina":
        terrainOk = inPlayerTerritory(q, r) && (teren === "laka" /* Laka */ || teren === "rownina" /* Rownina */) && isLivestockAllowed(playerCivArchetype, key, playerEra) && (hex.nakladka === "zloze_konia" /* ZlozeKonia */ || isLivestockUnlockedForPlacement(key, hex, empireUnlocks));
        break;
      case "droga":
      ...
      case "fort":
        ...
        break;
      case "glinianka":
        terrainOk = nakladka === "zloze_gliny" /* ZlozeGliny */ && inPlayerTerritory(q, r);
        break;
      case "kopalnia":
        if (!inPlayerTerritory(q, r)) terrainOk = false;
        else if (teren !== "gory" /* Gory */) terrainOk = nakladka === "zloze_rudy" /* ZlozeRudy */;
        else terrainOk = zloze === "zelazo" || zloze === "wegiel" || nakladka === "zloze_rudy" /* ZlozeRudy */;
        break;
      case "wyrab":
      ...
      case "warzelnia_soli":
        ...
        break;
      case "kopalnia_miedzi":
        terrainOk = inPlayerTerritory(q, r) && (teren === "wzgorza" /* Wzgorza */ || teren === "gory" /* Gory */) && zloze === "miedz";
        break;
      case "kopalnia_zlota":
...
function galleryTerrainEligible(key, teren) {
  switch (key) {
    case "farma":
      return FLAT_FARM.has(teren) || teren === "wzgorza" /* Wzgorza */;
    case "bydlo":
    ...
    case "lama":
      if (teren === "pustynia" /* Pustynia */ || teren === "morze" /* Morze */) return false;
    ...
    case "kopalnia_miedzi":
    case "kopalnia_zlota":
      return teren === "wzgorza" /* Wzgorza */ || teren === "gory" /* Gory */;
    case "wyrab":
      return teren === "laka" /* Laka */ || teren === "rownina" /* Rownina */ || teren === "wzgorza" /* Wzgorza */;
    case "glinianka":
      return teren === "laka" /* Laka */ || teren === "rownina" /* Rownina */;
    case "oboz_lowiecki":
      return teren === "laka" /* Laka */ || teren === "rownina" /* Rownina */;
    case "warzelnia_soli":
      return teren === "wybrzeze" /* Wybrzeze */ || teren === "rownina" /* Rownina */;
    case "droga":
    ...
    case "posterunek":
      return teren !== "morze" /* Morze */ && teren !== "wybrzeze" /* Wybrzeze */ && TERENY_LADU.has(teren);
    default:
      return false;
  }
}
...
function hasBrazAccess(empireStock, builtIds) {
  const stock = empireStock instanceof Map ? void 0 : empireStock ?? void 0;
  const hasStock = (stock?.braz ?? 0) > 0;
...
var IMPROVEMENTS3 = terrain_improvements_default;
var NAKLADKA_LABEL = {
...
function labelsForImprovementUnlock(improvementKey) {
  ...
  const keys = parseSurowiecOdblokowany(IMPROVEMENTS3[improvementKey]?.surowiecOdblokowany);
  if (keys.length === 0) return [];
...
var DEPOSIT_LINKED_IMPROVEMENTS = /* @__PURE__ */ new Set([
  "glinianka",
  "kopalnia",
  "kopalnia_miedzi",
  "warzelnia_soli",
  ...
  if (placedImprovements && sight > 0) {
    for (const [hexKey2, impKey] of placedImprovements) {
      ...
      for (const key of improvementKeysOnPlacedHex(impKey)) {
        if (!improvementUnlockActiveOnHex(key, hex)) continue;
        for (const label of activeLabelsForImprovementOnHex(key, hex)) {
          found.add(label);
        }
      }
    }
