...
function computePotegaNacji(k, w = DEFAULT_POTEGA_WAGI) {
  const raw = k.wielkoscArmii * w.wielkoscArmii + k.wygraneBitwy * w.wygraneBitwy + k.ludnosc * w.ludnosc + k.miasta * w.miasta + k.gospodarka * w.gospodarka + k.epoka * w.epoka;
