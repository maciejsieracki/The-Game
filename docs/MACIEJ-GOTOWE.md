- ✅ **FALA 256** `693a2c57` — relief mop-up C-MAPA-Q1=B (fair-play/żelazo Ogromny). Wejście: gra-robocza/START.html · git pull, Ctrl+F5 + Nowa gra.
- ✅ **FALA 255** `20e554dc` — ECHO ABC 6× + handoff sesji (logika = F254 Escape/recruit). **ZASTĄPIONA** przez 256. Czeka: DOPREC + `działaj` → 6 Autobotów.
...
- **2026-08-04 11:24** — ✅ Gotowe FALA 212 ROBOCZA `e38ad116`. Bugfixy (10 tematów, 8 naprawione): (1) Spichlerz auto-racje EOT + deficyt UI + czerwone wydarzenie **SPICH-AUTO-Q1** · (2) MP sameCiv +20 **REL-MP-SAME-Q1** · (3) obce MP bez wojny/klastera · (4) HEX magazyn UI tylko przy 👤 · (5) chatka toast nie nadpisywany weteranami · (6) scout → odkryta chatka · (7) odgarnizonowanie panel · (8) split w mieście · (9) forty MP=0 kanon · (10) Rel +1/tura tier pokoj — otwarte. Handoff: `dyspozycje/_handoff/BATCH-2026-08-04_FALA-212-bugfixy.md`. START: `gra-robocza/START.html` — **git pull**, Ctrl+F5 **Nowa gra**.
