- **2026-08-03 ~21:15** — ✅ Gotowe w kodzie (bez deploy): **R-DESIGN-BADANIA** — reskin panelu Badania Design v1 (`scienceHubHud.ts`). Branch `cursor/design-badania-v1-63a1`. Napisz **deploy** gdy wgrać do ROBOCZA.
