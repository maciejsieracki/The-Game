- **2026-08-03 ~21:35** — ✅ Gotowe w kodzie (bez deploy): **progi 1+2** — D3 W (sojusz≥0 / NAP≥−40) + cleanup martwych progów (NAP Zauf, wchłonięcie, fair-ratio). Branch `cursor/wiarygodnosc-progi-1-2-63a1`. Napisz **deploy** / merge.
- **2026-08-03 ~20:25** — ✅ Gotowe w kodzie (bez deploy): **D3 progi W** — sojusz W≥0 / NAP W≥−40. Branch `cursor/wiarygodnosc-d3-progi-63a1`. Napisz **deploy** gdy wgrać.
