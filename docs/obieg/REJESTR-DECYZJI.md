...
| **P-PODBOJ-MIAST-PANSTW-TRIUMF-POPUP-Q1** | 2026-08-17 | **A** — zachować warunek ostatniego aktywnego miasta-państwa tego samego klucza kultury co gracz; wyświetlić ceremonialny popup z kulturą i nazwą ostatniego miasta, bez przejścia do epoki Brązu | D+E | 🟡 **ZAPISANA** | Cytat Macieja z 2026-08-17; implementacja `triumph-city-state.ts` / `triumphCityStateNotice.ts` + testy | ECHO przed kodem |
