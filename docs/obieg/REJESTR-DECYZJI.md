...
| **P-REKRUTACJA-JEDNOSTEK-TYLKO-SKARBIEC-Q1** | 2026-08-17 | **B** — gracz, AI i miasta-państwa kupują jednostki wyłącznie za Skarbiec/Pieniądze; brak jednostek w kolejce Pracy budynków | B+D+F | **GOTOWE/ZAMKNIĘTE — Evaluator PASS-WITH-NOTES** | `docs/decyzje/P-REKRUTACJA-JEDNOSTEK-TYLKO-SKARBIEC-Q1.md` · implementacja `914ce8da` · test `rekrutacja-skarbiec-only-test.cjs` **13/13** · ROBOCZA F293 `8fa80b7c` → F294 `a0f804d7`, VERIFY OK | pre-existing dług osobno: `unit-stock-cost-test.cjs` **41/58**, `ai-recruit-upkeep-gate-test.cjs` **18/27**; bez zmian kodu/deployu w tym audycie |
| **R-KAMIEN-RELIEF-FOLLOWUP-Q1** | 2026-08-06 | **A** + reguła — `kopalnia` legacy + wszystkie kopalnie teraz i przyszłe zachowują relief | A+F | ✅ **ZDEPLOYOWANA / ZAMKNIĘTA** | `docs/decyzje/R-KAMIEN-RELIEF-FOLLOWUP-Q1.md` · `85932371` ancestor `main` · FALA 296 ROBOCZA `a37f7123` | Evaluator PASS-WITH-NOTES · test prefiksu 23/23 |
| **MAP-UX-CLUSTER-LABEL-Q1** | 2026-08-06 | **B+C** — stolica: nazwa cywilizacji + korona/obwódka; MP: nazwa + dopisek | A+E | ✅ **ZDEPLOYOWANA / ZAMKNIĘTA** | `docs/decyzje/MAP-UX-CLUSTER-LABEL-Q1.md` · `9d33e8f` + `d3470ed` ancestors `main` · FALA 296 ROBOCZA `a37f7123` | Evaluator PASS-WITH-NOTES · display 27/27 · badge 31/31 |
...
| **P-AI-BRAK-POJECIA-MGLY-Q1** | 2026-08-17 | **A+C** — własna mgła AI per owner; pamięć ostatniej pozycji; atak/akcja tylko po ponownym wykryciu | D | ✅ **WDROŻONA / ZAMKNIĘTA** | `docs/decyzje/P-AI-BRAK-POJECIA-MGLY-Q1.md` §ECHO + dowód FALA 292/294 | Evaluator PASS-WITH-NOTES · `ai-fog-test.cjs` 8/8 · kamera bitwy 24/24 · save/load W5 · ROBOCZA `a0f804d7` VERIFY OK |
...
| **P-PODBOJ-MIAST-PANSTW-TRIUMF-POPUP-Q1** | 2026-08-17 | **A** — zachować warunek ostatniego aktywnego miasta-państwa tego samego klucza kultury co gracz; wyświetlić ceremonialny popup z kulturą i nazwą ostatniego miasta, bez przejścia do epoki Brązu | D+E | ✅ **GOTOWE/ZAMKNIĘTE — Evaluator PASS-WITH-NOTES** | ECHO `94a70850`; implementacja `ae5ef14b` (`triumph-city-state.ts` / `triumphCityStateNotice.ts`); testy `13/13` i `16/16`; ROBOCZA md5 `a0f804d7` | bez epoki Brązu i innych podbojów |
