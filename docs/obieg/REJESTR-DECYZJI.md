...
| **P-SUROWCE-BAZA-DREWNO-KAMIEŃ-GLINA-Q1** | 2026-08-17 | **A** — bazowa produkcja terenu: Łąka 0/0/5, Równina 5/2/0, Wzgórza 5/5/5, Góry 0/10/0 (Drewno/Kamień/Glina); rzeka osobno | B | 🟡 **ZAPISANA** | `docs/decyzje/P-SUROWCE-BAZA-DREWNO-KAMIEŃ-GLINA-Q1.md` · implementacja po commicie ECHO | poprzednie propozycje zachowane jako historia |
