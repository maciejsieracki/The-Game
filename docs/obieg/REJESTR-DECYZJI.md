...
| **R-DESIGN-PANEL-MIASTA-Q2** | 2026-08-04 | **C** — MUST + hover (produkcja + ostrzeżenie surowców) | Design+E | 🔵 **W TRAKCIE** | j.w. · MUST kod OK · hover odłożony | always-on + hover Design |
...
| **SPICH-AUTO-Q1** | 2026-08-04 | **B** — EOT auto-obniża racje do bilansu=0; wojsko głoduje osobno; EOT bez blokady; event nast. tura **czerwony** (negatywny) | B | 🟡 **ZAPISANA** | `docs/decyzje/SPICH-AUTO-Q1.md` | doprecyz. UI 2026-08-04 · czeka `działaj` |
| **REL-MP-SAME-Q1** | 2026-08-04 | Start MP własnego typu: Zaufanie **+20** (nie −20); nadpisuje D-START §49 dla gracz↔MP; **bez** globalnej zmiany AI↔AI | D+F | 🟡 **ZAPISANA** | `docs/decyzje/REL-MP-SAME-Q1.md` | osobna ścieżka: `spawnPendingSameTypeRivals` · czeka `działaj` |
