...
**Stan:** 15/15 rozstrzygnięte (zapis uzupełniony MASTER 2026-06-28 z `docs/decyzje/` + sesje 2026-06-26…28).  
**Ostatnia aktualizacja:** 2026-06-28.

**Playtest v1.0 (lista do odhaczenia — nie teraz):** [`MACIEJ-PLAYTEST-CHECKLIST.md`](MACIEJ-PLAYTEST-CHECKLIST.md)
...
- **Twoja decyzja:** **C**  **Data:** 2026-06-27 *(ABC1=A mockupy D1B)*
...
- **Twoja decyzja:** **A**  **Data:** 2026-06-26 *(plaster wdrożony MASTER 2026-06-28)*
...
- **Twoja decyzja:** **A**  **Data:** 2026-06-26 *(B4-wealth.md — pełny model W1–W6)*
...
- **Twoja decyzja:** **A**  **Data:** 2026-06-27 *(A4-D4-ulepszenia.md)*
...
- **Twoja decyzja:** **B**  **Data:** 2026-06-27 *(C2-ux-bitwy.md — UI proponuje, Maciej zatwierdza)*
...
- **Twoja decyzja:** **A**  **Data:** 2026-06-28 *(konsolidacja — brak sprzeciwu, robocze zaokrętowanie OK)*
...
- **Twoja decyzja:** **B**  **Data:** 2026-06-27 *(C3-panel-armii.md)*
...
- **Twoja decyzja:** **A**  **Data:** 2026-06-26 *(A1-Q15 posiłki 1 heks — potwierdzenie B→A)*
...
- **Twoja decyzja:** **A**  **Data:** 2026-06-26 *(C4-zasady-walki.md — Katapulta=Żelazo)*
...
- **Twoja decyzja:** **A**  **Data:** 2026-06-26 *(D1-nauka.md — mockup bez przecięć)*
...
- **Twoja decyzja:** **A**  **Data:** 2026-06-27 *(A5-wyglad-miast-mapa.md — podgląd 4 nacji)*
...
- **Twoja decyzja:** **A**  **Data:** 2026-06-27 *(E1-nowa-gra.md / E1-D-cywilizacje-startowe.md)*
...
- **Twoja decyzja:** **B**  **Data:** 2026-06-26 *(A1-hud-mapy.md — siatka heksów UI)*
...
- **C:** Odpuść po v1.0.
- **Twoja decyzja:** **B**  **Data:** 2026-06-26 *(GLM/Composer/Opus wg playbooka Cursor)*
...
- **C:** Odłóż po v1.0.
- **Twoja decyzja:** **A**  **Data:** 2026-06-27 *(E3-surowce.md — złoża + łańcuch ruda→stal)*

### D16 — Banery liderów (top 3 AI) na HUD mapy
**Pytanie:** Po co trzy proporczyki (złoty/niebieski/czerwony) w prawym górnym rogu?
- **A:** Ukryć do v1.0 — wrócą z rankingiem CYWILIZACJE. ← **Twoja decyzja**
- **B:** Zostawić jako dekoracja mockupu 1E.
- **C:** Przenieść kontakty dyplomatyczne do Menu.
- **Twoja decyzja:** **A**  **Data:** 2026-07-03

### D17 — Panel kontekstowy (strefa C mockupu 1E)
**Pytanie:** Czy panel „kliknij jednostkę/miasto/pole” ma być widoczny cały czas?
- **A:** Ukryty domyślnie — treść tylko po wyborze jednostki lub heksu na mapie. ← **Twoja decyzja**
- **B:** Zostawić placeholder mockupu.
- **C:** Usunąć całkowicie.
- **Twoja decyzja:** **A**  **Data:** 2026-07-03
...
**Stan:** wszystkie pola wypełnione (MASTER backfill 2026-06-28 z `docs/decyzje/`).

| ID | Pytanie (skrót) | Rekom. | Twoja |
|---|---|---|---|
| D1 | HUD układ | C | **C** |
| D2 | Plaster ekonomii „idz" | A | **A** |
| D3 | Wealth scope | C | **A** *(pełny model — B4)* |
| D4 | Ulepszenia terenu | A | **A** |
| D5 | UX bitwy Q2-Q7 | B | **B** |
| D6 | Zaokrętowanie | A | **A** |
| D7 | Panel armii | B | **B** |
| D8 | Posiłki 1-heks | A | **A** |
| D9 | Subagenci Sonnet | B | **B** |
| D10 | Katapulta epoka | A | **A** |
| D11 | Drzewko układ | A | **A** |
| D12 | Miasta BRAZU | A | **A** |
| D13 | Defaulty startu | A | **A** |
| D14 | Surowce żelazo/stal | A | **A** |
| D15 | Minimapa wariant | B | **B** |
| D16 | Banery liderów HUD | A | **A** |
| D17 | Panel kontekstowy | A | **A** |
