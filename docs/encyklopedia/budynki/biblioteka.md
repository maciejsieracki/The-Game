...
**Biblioteka** — budynek (Nauka), epoka Brąz. Koszt od **25** pracy, utrzymanie **1** ¤/t. Technologia **Pismo**.
...
### Co robi
Biblioteka wzmacnia miasto w kategorii **Nauka**. Poziom 1: **+3 nauki** (+2 na poziom), **+1 kultury** (+1 na poziom). Maksymalnie **10** poziomów — każdy kosztuje więcej pracy (+**10** od poprzedniego), ale daje większy przyrost.
### Koszty
...
|------|-------------|-----------------|------------------|------------|
| Poziom 1 | 25 | **3 tur** | +3 nauki, +1 kultury | 1 ¤/t |
| Poziom 2 | 35 | **4 tur** | więcej (patrz niżej) | 1 ¤/t |
| Poziom 3 | 45 | — | **+7 nauki, +3 kultury** | 1 ¤/t |
