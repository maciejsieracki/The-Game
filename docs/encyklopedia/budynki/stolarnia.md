...
**Stolarnia** — budynek (Produkcja), epoka Kamień. Koszt od **20** pracy, utrzymanie **1** ¤/t. Technologia **Obróbka drewna**.
...
### Co robi
Stolarnia wzmacnia miasto w kategorii **Produkcja**. Poziom 1: **+5 pracy** (+3 na poziom). Maksymalnie **10** poziomów — każdy kosztuje więcej pracy (+**10** od poprzedniego), ale daje większy przyrost.
### Koszty
- **Budowa poz. 1:** 20 pracy
- **Każdy kolejny poziom:** +10 pracy
- **Utrzymanie:** 1 ¤/turę
- Technologia **Obróbka drewna**.
Warunek: las w zasiegu.
### Strategia gracza
...
|------|-------------|-----------------|------------------|------------|
| Poziom 1 | 20 | **2 tur** | +5 pracy | 1 ¤/t |
| Poziom 2 | 30 | **3 tur** | więcej (patrz niżej) | 1 ¤/t |
| Poziom 3 | 40 | — | **+11 pracy** | 1 ¤/t |

+5 pracy/t — przy koszcie 20 pracy inwestycja „wraca" w **4 tur** (jeśli cała nowa praca idzie w kolejkę).
