...
**Stela / Pomnik** — budynek (Kultura), epoka Kamień. Koszt od **15** pracy, utrzymanie **0** ¤/t. Technologia **Murarstwo**.
...
### Co robi
Stela / Pomnik wzmacnia miasto w kategorii **Kultura**. Poziom 1: **+1 kultury** (+1 na poziom). Maksymalnie **10** poziomów — każdy kosztuje więcej pracy (+**5** od poprzedniego), ale daje większy przyrost.
### Koszty
...
- Ignorowanie utrzymania: 0 ¤/t × 10 poziomów × kilka miast = wyczerpanie skarbca.
- Rush za złoto „na siłę" przy pustym skarbcu — najpierw Targowisko / podatki.
**Powiązane:** Produkcja miejska · Utrzymanie · Kultura
...
|------|-------------|-----------------|------------------|------------|
| Poziom 1 | 15 | **2 tur** | +1 kultury | 0 ¤/t |
| Poziom 2 | 20 | **2 tur** | więcej (patrz niżej) | 0 ¤/t |
| Poziom 3 | 25 | — | **+3 kultury** | 0 ¤/t |
