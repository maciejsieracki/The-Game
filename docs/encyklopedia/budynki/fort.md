...
**Fort** — budynek (Obrona), epoka Żelazo. Koszt od **70** pracy, utrzymanie **3** ¤/t. Technologia **Inżynieria**.
...
### Co robi
Fort wzmacnia miasto w kategorii **Obrona**. Poziom 1: **+10 obrony** (+5 na poziom). Maksymalnie **10** poziomów — każdy kosztuje więcej pracy (+**15** od poprzedniego), ale daje większy przyrost.
### Koszty
...
|------|-------------|-----------------|------------------|------------|
| Poziom 1 | 70 | **7 tur** | +10 obrony | 3 ¤/t |
| Poziom 2 | 85 | **9 tur** | więcej (patrz niżej) | 3 ¤/t |
| Poziom 3 | 100 | — | **+20 obrony** | 3 ¤/t |
