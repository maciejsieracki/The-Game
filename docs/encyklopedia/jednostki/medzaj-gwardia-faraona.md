...
**Medżaj (Gwardia Faraona)** (Wręcz, Brąz): rekrutacja **0** ¤ + **1** mieszk., utrzymanie **0** ¤/t i **1** żywn./t. Siła w polu **64.5**.
...
**Siła w polu:** **64.5** — porównaj z **Wojownikiem (~27)** lub **Wojownikiem z mieczem (~39)** na tym samym terenie.
