...
| Pole | Wartość |
|------|---------|
| **id** | `wojownik-z-toporem` |
| **tytuł** | Wojownik z toporem |
...
**Wojownik z toporem** (Wręcz, Brąz): rekrutacja **18** ¤ + **1** mieszk., utrzymanie **2** ¤/t i **1** żywn./t. Siła w polu **32.5**.
...
### Rola
Wojownik z toporem to jednostka typu **Wręcz** z epoki **Brąz**. Unikalna dla **Inkowie**.
...
**Siła w polu:** **32.5** — porównaj z **Wojownikiem (~27)** lub **Wojownikiem z mieczem (~39)** na tym samym terenie.
