...
| Pole | Wartość |
|------|---------|
| **id** | `wojownik-z-maczuga-chaska` |
| **tytuł** | Wojownik z maczugą (Chaska) |
...
### Rola
Wojownik z maczugą (Chaska) to jednostka typu **Wręcz** z epoki **Kamień**. Unikalna dla **Inkowie**.
### Rekrutacja i utrzymanie
- **Koszt:** 26 ¤, 1 mieszkańców
...
**Rekrutacja:** **26 ¤** ze skarbca + **1** mieszkańców (np. pop. 5 → 4 po werbunku).
