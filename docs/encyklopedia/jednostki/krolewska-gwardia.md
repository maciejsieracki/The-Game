...
| Pole | Wartość |
|------|---------|
| **id** | `krolewska-gwardia` |
| **tytuł** | Królewska Gwardia |
...
**Królewska Gwardia** (Wręcz, Brąz): rekrutacja **0** ¤ + **1** mieszk., utrzymanie **0** ¤/t i **1** żywn./t. Siła w polu **52**.
...
### Rola
Królewska Gwardia to jednostka typu **Wręcz** z epoki **Brąz**. Unikalna dla **Inkowie**.
...
**Siła w polu:** **52** — porównaj z **Wojownikiem (~21,5)** lub **Wojownikiem z mieczem (~25)** na tym samym terenie.
