...
| Pole | Wartość |
|------|---------|
| **id** | `hieros-lochos-swiety-zastep` |
| **tytuł** | Hieros Lochos (Święty Zastęp) |
...
**Hieros Lochos (Święty Zastęp)** (Wręcz, Brąz): rekrutacja **0** ¤ + **1** mieszk., utrzymanie **0** ¤/t i **1** żywn./t. Siła w polu **52.5**.
...
### Rola
Hieros Lochos (Święty Zastęp) to jednostka typu **Wręcz** z epoki **Brąz**. Unikalna dla **Grecka**.
