...
**Wojownik** (Wręcz, Kamień): rekrutacja **10** ¤ + **1** mieszk., utrzymanie **1** ¤/t i **1** żywn./t. Siła w polu **27**.
...
**Siła w polu:** **27** — porównaj z **Wojownikiem (~27)** lub **Wojownikiem z mieczem (~39)** na tym samym terenie.
