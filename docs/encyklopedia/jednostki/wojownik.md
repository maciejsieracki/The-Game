...
**Wojownik** (Wręcz, Kamień): rekrutacja **10** ¤ + **1** mieszk., utrzymanie **1** ¤/t i **1** żywn./t. Siła w polu **21.5**.
...
### Rola
Wojownik to jednostka typu **Wręcz** z epoki **Kamień**. Dostępna wielu cywilizacjom po odblokowaniu epoki/tech.
### Rekrutacja i utrzymanie
- **Koszt:** 10 ¤, 1 mieszkańców
...
**Siła w polu:** **21.5** — porównaj z **Wojownikiem (~21,5)** lub **Wojownikiem z mieczem (~25)** na tym samym terenie.
