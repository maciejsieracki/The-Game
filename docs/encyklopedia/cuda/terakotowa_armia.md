...
**Terakotowa armia** (cud wyłączny) — koszt **320** pracy, max **1 na świat**.
...
- **320 pracy** — planuj kilka tur produkcji w mieście stołecznym.
...
**Plan budowy:** stolica produkuje **12 pracy/t** na cuda (suwak pracy 70%). Cud **320** pracy → ok. **27 tur** bez rush.

**Po wzniesieniu:** utrzymanie z JSON (np. **2–5 ¤/t**) — policz w skarbcu: 5 ¤/t × 50 tur = **250 ¤** do absolutu.

**Porównanie:** zwykły Teatr **55** pracy, cud **320** — cud to inwestycia na całą grę do absolutu, nie na jedno miasto.
