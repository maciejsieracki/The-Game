...
**Wyrocznia** (cud wyścigowy) — koszt **180** pracy, max **1 na świat**.
...
- **180 pracy** — planuj kilka tur produkcji w mieście stołecznym.
...
**Plan budowy:** stolica produkuje **12 pracy/t** na cuda (suwak pracy 70%). Cud **180** pracy → ok. **15 tur** bez rush.

**Po wzniesieniu:** utrzymanie z JSON (np. **2–5 ¤/t**) — policz w skarbcu: 5 ¤/t × 50 tur = **250 ¤** do absolutu.

**Porównanie:** zwykły Teatr **55** pracy, cud **180** — cud to inwestycia na całą grę do absolutu, nie na jedno miasto.
