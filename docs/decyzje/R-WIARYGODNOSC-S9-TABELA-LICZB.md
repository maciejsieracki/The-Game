...
| `wiarygodnoscProgNapMin` | −40 | pkt Wiarygodności — twardy próg Dźwigni 3: propozycja Paktu o Nieagresji wymaga W ≥ próg | −40 (bez zmian) | Dokładnie na granicy pasma „Wiarołomny" (`wiarygodnoscProgWiarolomny=−40`) — NAP jest niedostępny wyłącznie dla najgorszego pasma reputacji, co jest czytelne w UI („Wiarołomni nie dostają nawet NAP"). Decyzja §9.10=A (NAP, nie Wasal/Trybut) już zamknięta. | POTWIERDZENIE |
