...
| 2 | Adwokat diabła (osobny przebieg) — **OBOWIĄZKOWO SCOPE + regresja** (`R-PROC-AUTOBOT-EVAL-SCOPE`) + **STRICT** (`R-PROC-AUTOBOT-EVAL-STRICT`) + **STRICT-EDGE** (`R-PROC-AUTOBOT-EVAL-STRICT-EDGE`) + **STRICT-PARITY** (`R-PROC-AUTOBOT-EVAL-STRICT-PARITY`) | `composer-2.5` |
| 3 | Final | Grok 4.5 |
