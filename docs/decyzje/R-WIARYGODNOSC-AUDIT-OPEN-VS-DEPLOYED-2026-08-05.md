...
|------------|------|-----|--------------|
| **WIAR-NAP-IMP** | ✅ **WDROŻONE** — NAP terminowy (10–20 tur) lub bezterminowy (`wygasaTura: null`) + koszyk audiencji. | Implementacja | Nie |
...
**Backlog (nie ABC):** — (brak; strojenie liczb = post-playtest)

**Zamknięte / wdrożone:** `WIAR-NAP-IMP` · `WIAR-UI-REJESTR` · `C-WIAR-D4` · `C-WIAR-N1-UX` · `C-WIAR-N4-AI` · `D-WIAR-KASKADA-Q1` · `REL-WIARYG-DRIFT-Q1` · `R-WIARYGODNOSC-D3` · `R-WIARYGODNOSC-DZWIGNIA2` · `R-WIARYGODNOSC-TEMPO` (R1/R1b) · `R-WIARYGODNOSC-ETAP0` · przegląd R1–R4
