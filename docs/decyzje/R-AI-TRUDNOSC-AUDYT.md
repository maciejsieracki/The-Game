...
| `cuda_poziom{1,2,3}_prog_koszt_x` + `throttle_tur` | 25/8 · 45/5 · **80**/2 | `loadAiWonderParams` → `decideAiWonderBuild` | Cuda po stabilnej ekonomii — L3 agresywniej (STEP3: throttle 3→2; STEP4: prog 70→80). |
