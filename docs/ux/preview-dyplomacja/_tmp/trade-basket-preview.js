...
var TradeBasketPreview = (() => {
  ...
  // tools/.trade-basket-preview-entry.ts
  var trade_basket_preview_entry_exports = {};
  __export(trade_basket_preview_entry_exports, {
    mountTradeBasketPreview: () => mountTradeBasketPreview
  });
  ...
  var tech_default = {
    ...
    technologie: [
      ...
      },
      {
        ...
        "Odblokowuje budynek": "Odlewnia \u017Celaza; Ku\u017Ania \u017Celaza; Jednostki: Hastati, Falanga, Dru\u017Cynnik, Garnizon Harappy, Gwardia hetycka, Piechota neobabilo\u0144ska, Tyrski miecznik, Gwardia Tyre\u0144ska, Thorakites, iButho z iklwa, Wojownik z \u017Celaznym khopesh, Mur tarcz (Sargonid), Miecznik galijski, Rydwan celtycki, Konnica lancowa asyryjska, Konnica \u0142ucznicza asyryjska, Je\u017Adziec z oszczepami",
        "Koszt nauki": 240,
        Uwagi: "ko\u0144czy Epok\u0119 2 / otwiera Epok\u0119 3; Odlewnia \u017Celaza = upgrade Odlewni br\u0105zu (br\u0105z+\u017Celazo); Ku\u017Ania \u017Celaza = \u0142a\u0144cuch pancerza (osobny slot)",
        "Odblokowuje ulepszenie terenu": null,
        awansDoEpoki: 3
      },
      {
      ...
      },
      {
        ...
        "Odblokowuje budynek": "Wielka odlewnia; Wielka Ku\u017Ania; Jednostki: Gaesatae, Soldurii, Wojownik germa\u0144ski, Berserker germa\u0144ski",
        "Koszt nauki": 370,
        Uwagi: "Wielka odlewnia = produkcja stal+metale (br\u0105z+\u017Celazo+stal); Wielka Ku\u017Ania = tylko pancerz +45% \u0142a\u0144cuch ku\u017Ani; stal = NOWY surowiec dla DANE (prereq dalszych epok)",
        "Odblokowuje ulepszenie terenu": null
      },
      {
  ...
  var buildings_default = [
    ...
    },
    {
      ...
      uwagi: "Upgrade Odlewni br\u0105zu \u2192 Odlewnia \u017Celaza. Produkuje BR\u0104Z (jak tier1) + \u017BELAZO r\xF3wnolegle (dwa konwertery, jeden slot). Decyzja 42A (Maciej 2026-07-25): Praca 8\u219212 pkt/tur\u0119. LANCUCH W GORE: maksPoziom=1 \u2014 awans na Wielka odlewnia.",
    ...
    },
    {
      ...
      wymagania: "upgrade Odlewni \u017Celaza; dost\u0119p do Stali w imperium (aktywne \u017Ar\xF3d\u0142o lub zapas w magazynie pa\u0144stwa)",
      wymaganySurowiec: "stal",
      uwagi: "Upgrade Odlewnia \u017Celaza \u2192 Wielka odlewnia. Produkuje BR\u0104Z + \u017BELAZO + STAL (trzy konwertery, jeden slot). PARKOWANE: epokaWejscia=4. LANCUCH W GORE: maksPoziom=1 (koniec \u0142a\u0144cucha odlewni). Wielka Ku\u017Ania = tylko Pancerz, NIE stal.",
      techUnlock: "Obr\xF3bka \u017Celaza",
      upgradeFrom: "odlewnia_zelaza",
      koszt_surowce: {
        drewno: 12,
        cegla: 14
      }
    ...
    },
    {
      ...
      wymaganySurowiec: "stal",
      uwagi: "Upgrade Ku\u017Ania \u017Celaza \u2192 Wielka Ku\u017Ania. Mnoznik = +15% Pancerz (Sciezka A), NIE kumuluje sie z Kuznia zelaza bo ja zastepuje (upgradeFrom). TYLKO pancerz \u2014 NIE produkuje stali (stal = Wielka odlewnia, Maciej 2026-07-27). PARKOWANE: epokaWejscia=4. LANCUCH W GORE: maksPoziom=1 (koniec lancucha ku\u017Ani).",
      techUnlock: "Obr\xF3bka \u017Celaza",
  ...
  var econ_params_default = {
    ...
    budynki: {
      ...
      budynek_huta_przepustowosc: {
        ...
        hard: 0,
        jednostka: "szt/tur\u0119",
        opis: "Maks konwersja (Ruda+Drewno)\u2192Br\u0105z w Odlewni br\u0105zu (i tier wy\u017Cszy \u0142a\u0144cucha odlewni) na tur\u0119. [PT]"
      },
      budynek_odlewnia_zelaza_przepustowosc: {
        easy: 2,
        normal: 1,
        hard: 0,
        jednostka: "szt/tur\u0119",
        opis: "Maks konwersja (Ruda \u017Celaza+Drewno)\u2192\u017Belazo w Odlewni \u017Celaza / Wielka odlewnia na tur\u0119. [PT]"
      },
      budynek_wielka_odlewnia_przepustowosc: {
        easy: 2,
        normal: 1,
        hard: 0,
        jednostka: "szt/tur\u0119",
        opis: "Maks konwersja (\u017Belazo+Drewno)\u2192Stal w Wielka odlewnia na tur\u0119 (Maciej 2026-07-27: przeniesione z Wielka Ku\u017Ania). [PT]"
      },
      budynek_garncarnia_przepustowosc: {
        ...
        hard: 4,
        jednostka: "szt/tur\u0119",
        opis: "Maks konwersja (Glina+Drewno)\u2192Ceramika w Garncarni na tur\u0119 (PYTANIE-84-B5). [PT]"
      },
      budynek_spichlerz_zuzywa_ceramika: {
        easy: 5,
        normal: 5,
        hard: 5,
        jednostka: "Ceramika/tur\u0119",
        opis: "PYTANIE-84-B6 (Maciej 2026-07-27): Spichlerz I zu\u017Cywa Ceramik\u0119 ze skarbca pa\u0144stwa co tur\u0119; brak surowca \u2192 brak bonus\xF3w ludno\u015Bci (U-24=B, U-25B)."
      },
      budynek_spichlerz_ii_zuzywa_sol: {
        easy: 5,
        normal: 5,
        hard: 5,
        jednostka: "S\xF3l/tur\u0119",
        opis: "PYTANIE-84-B7/U-2 (Maciej 2026-07-27): Spichlerz II zu\u017Cywa S\xF3l ze skarbca \xD7 ka\u017Cdy dzia\u0142aj\u0105cy Spichlerz II p\u0142ac\u0105cy S\xF3l; brak Soli \u2192 brak bonusu wojska (imperium-wide)."
      },
      budynek_spichlerz_ii_zuzywa_ceramika: {
        easy: 5,
        normal: 5,
        hard: 5,
        jednostka: "Ceramika/tur\u0119",
        opis: "PYTANIE-84-B8 (Maciej 2026-07-27): Spichlerz II zu\u017Cywa Ceramik\u0119 ze skarbca co tur\u0119 (obok Soli); brak Ceramiki \u2192 brak bonusu ludno\u015Bci w mie\u015Bcie."
      },
      utrzymanie_budynek: {
        easy: 1,
        normal: 1,
  ...
  function diplomacyHandelSurowceCatalog() {
    const out = {};
  ...
  function diplomacySurplusPn(givePn, receivePn, relacja) {
    const fair = diplomacyFairGivePn(receivePn, relacja);
    return Math.max(0, givePn - fair);
  }
  function diplomacyPnToZaufanieDelta(surplusPn, params = _pnRelacja) {
  ...
  function diplomacyTrustFromSurplus(surplusPn, alreadyGainedThisTurn, params) {
  ...
  function diplomacyTradeTrustFromDeal(givePn, receivePn, relacja, alreadyGainedThisTurn = 0, params) {
  ...
  function diplomacyGiftTrustFromPn(givePn, alreadyGainedThisTurn = 0, params) {
    return diplomacyTradeTrustFromDeal(givePn, 0, 100, alreadyGainedThisTurn, params);
  }
  function diplomacyPnRelacjaParams() {
    return _pnRelacja;
  }
  function diplomacyDobraWolaFromSurplus(surplusPn, params = _pnRelacja) {
    const cfg = { ..._pnRelacja, ...params };
  ...
  function diplomacyHandelZaufaniePerTura() {
  ...
  function stripWithdrawnResourceAccessItems(items) {
  ...
  // src/ui/icons/brand/icons-manifest.json
  var icons_manifest_default = {
    note: "The Game 1E \u2014 mapa id\u2192\u015Bcie\u017Cki SVG (24/40). FROZEN v1.0. + set menu (15).",
    frozen: true,
    icons: {
      "res-food": {
        "24": "eksport/icons/tier1/res-food-24.svg",
        "40": "eksport/icons/tier1/res-food-40.svg",
        tier: "tier1"
      },
      "res-work": {
        "24": "eksport/icons/tier1/res-work-24.svg",
        "40": "eksport/icons/tier1/res-work-40.svg",
        tier: "tier1"
      },
      "res-treasury": {
        "24": "eksport/icons/tier1/res-treasury-24.svg",
        "40": "eksport/icons/tier1/res-treasury-40.svg",
        tier: "tier1"
      },
      "res-science": {
        "24": "eksport/icons/tier1/res-science-24.svg",
        "40": "eksport/icons/tier1/res-science-40.svg",
        tier: "tier1"
      },
      "res-culture": {
        "24": "eksport/icons/tier1/res-culture-24.svg",
        "40": "eksport/icons/tier1/res-culture-40.svg",
        tier: "tier1"
      },
      "res-religion": {
        "24": "eksport/icons/tier1/res-religion-24.svg",
        "40": "eksport/icons/tier1/res-religion-40.svg",
        tier: "tier1"
      },
      "res-population": {
        "24": "eksport/icons/tier1/res-population-24.svg",
        "40": "eksport/icons/tier1/res-population-40.svg",
        tier: "tier1"
      },
      "res-influence": {
        "24": "eksport/icons/tier1/res-influence-24.svg",
        "40": "eksport/icons/tier1/res-influence-40.svg",
        tier: "tier1"
      },
      "res-settlements": {
        "24": "eksport/icons/tier1/res-settlements-24.svg",
        "40": "eksport/icons/tier1/res-settlements-40.svg",
        tier: "tier1"
      },
      "tb-cities": {
        "24": "eksport/icons/tier2/tb-cities-24.svg",
        "40": "eksport/icons/tier2/tb-cities-40.svg",
        tier: "tier2"
      },
      "tb-science": {
        "24": "eksport/icons/tier2/tb-science-24.svg",
        "40": "eksport/icons/tier2/tb-science-40.svg",
        tier: "tier2"
      },
      "tb-diplomacy": {
        "24": "eksport/icons/tier2/tb-diplomacy-24.svg",
        "40": "eksport/icons/tier2/tb-diplomacy-40.svg",
        tier: "tier2"
      },
      "tb-army": {
        "24": "eksport/icons/tier2/tb-army-24.svg",
        "40": "eksport/icons/tier2/tb-army-40.svg",
        tier: "tier2"
      },
      "tb-build": {
        "24": "eksport/icons/tier2/tb-build-24.svg",
        "40": "eksport/icons/tier2/tb-build-40.svg",
        tier: "tier2"
      },
      "cp-buildings": {
        "24": "eksport/icons/tier3/cp-buildings-24.svg",
        "40": "eksport/icons/tier3/cp-buildings-40.svg",
        tier: "tier3"
      },
      "cp-recruit": {
        "24": "eksport/icons/tier3/cp-recruit-24.svg",
        "40": "eksport/icons/tier3/cp-recruit-40.svg",
        tier: "tier3"
      },
      "cp-granary": {
        "24": "eksport/icons/tier3/cp-granary-24.svg",
        "40": "eksport/icons/tier3/cp-granary-40.svg",
        tier: "tier3"
      },
      "cp-trade": {
        "24": "eksport/icons/tier3/cp-trade-24.svg",
        "40": "eksport/icons/tier3/cp-trade-40.svg",
        tier: "tier3"
      },
      "cp-labor": {
        "24": "eksport/icons/tier3/cp-labor-24.svg",
        "40": "eksport/icons/tier3/cp-labor-40.svg",
        tier: "tier3"
      },
      "cp-order": {
        "24": "eksport/icons/tier3/cp-order-24.svg",
        "40": "eksport/icons/tier3/cp-order-40.svg",
        tier: "tier3"
      },
      "cp-health": {
        "24": "eksport/icons/tier3/cp-health-24.svg",
        "40": "eksport/icons/tier3/cp-health-40.svg",
        tier: "tier3"
      },
      "cp-culture": {
        "24": "eksport/icons/tier3/cp-culture-24.svg",
        "40": "eksport/icons/tier3/cp-culture-40.svg",
        tier: "tier3"
      },
      "cp-religion": {
        "24": "eksport/icons/tier3/cp-religion-24.svg",
        "40": "eksport/icons/tier3/cp-religion-40.svg",
        tier: "tier3"
      },
      "chip-manpower": {
        "24": "eksport/icons/tier4/chip-manpower-24.svg",
        "40": "eksport/icons/tier4/chip-manpower-40.svg",
        tier: "tier4"
      },
      "chip-order": {
        "24": "eksport/icons/tier4/chip-order-24.svg",
        "40": "eksport/icons/tier4/chip-order-40.svg",
        tier: "tier4"
      },
      "chip-happiness": {
        "24": "eksport/icons/tier4/chip-happiness-24.svg",
        "40": "eksport/icons/tier4/chip-happiness-40.svg",
        tier: "tier4"
      },
      "chip-garrison": {
        "24": "eksport/icons/tier4/chip-garrison-24.svg",
        "40": "eksport/icons/tier4/chip-garrison-40.svg",
        tier: "tier4"
      },
      "chip-warning": {
        "24": "eksport/icons/tier4/chip-warning-24.svg",
        "40": "eksport/icons/tier4/chip-warning-40.svg",
        tier: "tier4"
      },
      "chip-rebellion": {
        "24": "eksport/icons/tier4/chip-rebellion-24.svg",
        "40": "eksport/icons/tier4/chip-rebellion-40.svg",
        tier: "tier4"
      },
      "chip-death": {
        "24": "eksport/icons/tier4/chip-death-24.svg",
        "40": "eksport/icons/tier4/chip-death-40.svg",
        tier: "tier4"
      },
      "chip-heart": {
        "24": "eksport/icons/tier4/chip-heart-24.svg",
        "40": "eksport/icons/tier4/chip-heart-40.svg",
        tier: "tier4"
      },
      "chip-grain": {
        "24": "eksport/icons/tier4/chip-grain-24.svg",
        "40": "eksport/icons/tier4/chip-grain-40.svg",
        tier: "tier4"
      },
      "chip-crate": {
        "24": "eksport/icons/tier4/chip-crate-24.svg",
        "40": "eksport/icons/tier4/chip-crate-40.svg",
        tier: "tier4"
      },
      "chip-map": {
        "24": "eksport/icons/tier4/chip-map-24.svg",
        "40": "eksport/icons/tier4/chip-map-40.svg",
        tier: "tier4"
      },
      "chip-star": {
        "24": "eksport/icons/tier4/chip-star-24.svg",
        "40": "eksport/icons/tier4/chip-star-40.svg",
        tier: "tier4"
      },
      "chip-trend-up": {
        "24": "eksport/icons/tier4/chip-trend-up-24.svg",
        "40": "eksport/icons/tier4/chip-trend-up-40.svg",
        tier: "tier4"
      },
      "dip-alliance": {
        "24": "eksport/icons/tier5/dip-alliance-24.svg",
        "40": "eksport/icons/tier5/dip-alliance-40.svg",
        tier: "tier5"
      },
      "dip-pact": {
        "24": "eksport/icons/tier5/dip-pact-24.svg",
        "40": "eksport/icons/tier5/dip-pact-40.svg",
        tier: "tier5"
      },
      "dip-peace": {
        "24": "eksport/icons/tier5/dip-peace-24.svg",
        "40": "eksport/icons/tier5/dip-peace-40.svg",
        tier: "tier5"
      },
      "dip-war": {
        "24": "eksport/icons/tier5/dip-war-24.svg",
        "40": "eksport/icons/tier5/dip-war-40.svg",
        tier: "tier5"
      },
      "dip-war-strip": {
        "24": "eksport/icons/tier5/dip-war-strip-24.svg",
        "40": "eksport/icons/tier5/dip-war-strip-40.svg",
        tier: "tier5"
      },
      "ui-menu": {
        "24": "eksport/icons/tier5/ui-menu-24.svg",
        "40": "eksport/icons/tier5/ui-menu-40.svg",
        tier: "tier5"
      },
      "ui-wiki": {
        "24": "eksport/icons/tier5/ui-wiki-24.svg",
        "40": "eksport/icons/tier5/ui-wiki-40.svg",
        tier: "tier5"
      },
      "ui-close": {
        "24": "eksport/icons/tier5/ui-close-24.svg",
        "40": "eksport/icons/tier5/ui-close-40.svg",
        tier: "tier5"
      },
      "ui-play": {
        "24": "eksport/icons/tier5/ui-play-24.svg",
        "40": "eksport/icons/tier5/ui-play-40.svg",
        tier: "tier5"
      },
      "ui-pause": {
        "24": "eksport/icons/tier5/ui-pause-24.svg",
        "40": "eksport/icons/tier5/ui-pause-40.svg",
        tier: "tier5"
      },
      "ui-end-turn": {
        "24": "eksport/icons/tier5/ui-end-turn-24.svg",
        "40": "eksport/icons/tier5/ui-end-turn-40.svg",
        tier: "tier5"
      },
      "ui-check": {
        "24": "eksport/icons/tier5/ui-check-24.svg",
        "40": "eksport/icons/tier5/ui-check-40.svg",
        tier: "tier5"
      },
      "ui-lock": {
        "24": "eksport/icons/tier5/ui-lock-24.svg",
        "40": "eksport/icons/tier5/ui-lock-40.svg",
        tier: "tier5"
      },
      "ui-denied": {
        "24": "eksport/icons/tier5/ui-denied-24.svg",
        "40": "eksport/icons/tier5/ui-denied-40.svg",
        tier: "tier5"
      },
      "ui-accepted": {
        "24": "eksport/icons/tier5/ui-accepted-24.svg",
        "40": "eksport/icons/tier5/ui-accepted-40.svg",
        tier: "tier5"
      },
      "field-food": {
        "24": "eksport/icons/tier6/field-food-24.svg",
        "40": "eksport/icons/tier6/field-food-40.svg",
        tier: "tier6"
      },
      "field-production": {
        "24": "eksport/icons/tier6/field-production-24.svg",
        "40": "eksport/icons/tier6/field-production-40.svg",
        tier: "tier6"
      },
      "field-tax": {
        "24": "eksport/icons/tier6/field-tax-24.svg",
        "40": "eksport/icons/tier6/field-tax-40.svg",
        tier: "tier6"
      },
      "field-balanced": {
        "24": "eksport/icons/tier6/field-balanced-24.svg",
        "40": "eksport/icons/tier6/field-balanced-40.svg",
        tier: "tier6"
      },
      "terrain-plains": {
        "24": "eksport/icons/tier7/terrain-plains-24.svg",
        "40": "eksport/icons/tier7/terrain-plains-40.svg",
        tier: "tier7"
      },
      "terrain-hills": {
        "24": "eksport/icons/tier7/terrain-hills-24.svg",
        "40": "eksport/icons/tier7/terrain-hills-40.svg",
        tier: "tier7"
      },
      "terrain-mountains": {
        "24": "eksport/icons/tier7/terrain-mountains-24.svg",
        "40": "eksport/icons/tier7/terrain-mountains-40.svg",
        tier: "tier7"
      },
      "terrain-desert": {
        "24": "eksport/icons/tier7/terrain-desert-24.svg",
        "40": "eksport/icons/tier7/terrain-desert-40.svg",
        tier: "tier7"
      },
      "terrain-water": {
        "24": "eksport/icons/tier7/terrain-water-24.svg",
        "40": "eksport/icons/tier7/terrain-water-40.svg",
        tier: "tier7"
      },
      "menu-play": {
        "24": "eksport/icons/menu/menu-play-24.svg",
        "40": "eksport/icons/menu/menu-play-40.svg",
        tier: "menu"
      },
      "menu-campaign": {
        "24": "eksport/icons/menu/menu-campaign-24.svg",
        "40": "eksport/icons/menu/menu-campaign-40.svg",
        tier: "menu"
      },
      "menu-multiplayer": {
        "24": "eksport/icons/menu/menu-multiplayer-24.svg",
        "40": "eksport/icons/menu/menu-multiplayer-40.svg",
        tier: "menu"
      },
      "menu-settings": {
        "24": "eksport/icons/menu/menu-settings-24.svg",
        "40": "eksport/icons/menu/menu-settings-40.svg",
        tier: "menu"
      },
      "menu-more": {
        "24": "eksport/icons/menu/menu-more-24.svg",
        "40": "eksport/icons/menu/menu-more-40.svg",
        tier: "menu"
      },
      "menu-exit": {
        "24": "eksport/icons/menu/menu-exit-24.svg",
        "40": "eksport/icons/menu/menu-exit-40.svg",
        tier: "menu"
      },
      "menu-emblem-mini": {
        "24": "eksport/icons/menu/menu-emblem-mini-24.svg",
        "40": "eksport/icons/menu/menu-emblem-mini-40.svg",
        tier: "menu"
      },
      "menu-load": {
        "24": "eksport/icons/menu/menu-load-24.svg",
        "40": "eksport/icons/menu/menu-load-40.svg",
        tier: "menu"
      },
      "menu-save": {
        "24": "eksport/icons/menu/menu-save-24.svg",
        "40": "eksport/icons/menu/menu-save-40.svg",
        tier: "menu"
      },
      "menu-credits": {
        "24": "eksport/icons/menu/menu-credits-24.svg",
        "40": "eksport/icons/menu/menu-credits-40.svg",
        tier: "menu"
      },
      "menu-language": {
        "24": "eksport/icons/menu/menu-language-24.svg",
        "40": "eksport/icons/menu/menu-language-40.svg",
        tier: "menu"
      },
      "menu-audio": {
        "24": "eksport/icons/menu/menu-audio-24.svg",
        "40": "eksport/icons/menu/menu-audio-40.svg",
        tier: "menu"
      },
      "menu-controls": {
        "24": "eksport/icons/menu/menu-controls-24.svg",
        "40": "eksport/icons/menu/menu-controls-40.svg",
        tier: "menu"
      },
      "menu-achievements": {
        "24": "eksport/icons/menu/menu-achievements-24.svg",
        "40": "eksport/icons/menu/menu-achievements-40.svg",
        tier: "menu"
      },
      "menu-info": {
        "24": "eksport/icons/menu/menu-info-24.svg",
        "40": "eksport/icons/menu/menu-info-40.svg",
        tier: "menu"
      }
    }
  };

  // src/ui/icons/brand/resources-map-icon-map.json
  var resources_map_icon_map_default = {
    note: "Etykieta zloza/surowca gry (resource-access.ts: hexDepositDisplayLabel / SUROWIEC_KEY_LABEL) \u2192 plik res-*.svg w resources-map/. Dopasowanie w brandAssets.mapResourceIconSvg jest case-insensitive: najpierw exact, potem substring z najdluzszym dopasowanym kluczem (jak resourceBrandKey w cityPanel), wiec klucze polskie z diakrytykami i warianty (np. 'Ruda zelaza', 'Bydlo (krowa/wol)') trafiaja poprawnie. Design v4 (2026-07-24): rudy rozdzielone na res-copper-ore (goly 'ruda' = Ruda miedzi, main.ts:1728 id:'ruda') i res-iron-ore ('ruda zelaza'/'ruda_zelaza' \u2014 dluzszy klucz wygrywa substring nad golym 'ruda'); braz/zelazo/stal/cegla/ceramika maja teraz wlasne ikony (wczesniej fallback na res-iron/res-clay).",
    map: {
      z\u0142oto: "res-gold",
      zloto: "res-gold",
      \u017Celazo: "res-iron",
      zelazo: "res-iron",
      "ruda \u017Celaza": "res-iron-ore",
      "ruda zelaza": "res-iron-ore",
      ruda_zelaza: "res-iron-ore",
      "ruda miedzi": "res-copper-ore",
      ruda_miedzi: "res-copper-ore",
      mied\u017A: "res-copper-ore",
      miedz: "res-copper-ore",
      ruda: "res-copper-ore",
      stal: "res-steel",
      br\u0105z: "res-bronze",
      braz: "res-bronze",
      ...
      ceg\u0142a: "res-brick",
      cegla: "res-brick",
      ceramika: "res-ceramics",
      byd\u0142o: "res-cattle",
      bydlo: "res-cattle",
      "byd\u0142o (krowa/w\xF3\u0142)": "res-cattle",
      "bydlo (krowa/wol)": "res-cattle",
      owce: "res-cattle",
      lama: "res-cattle",
      _default: "res-stone"
    }
  ...
  // src/ui/icons/brandAssets.ts
  var import_meta = {};
  var svgBySuffix = import_meta.glob("./brand/**/*.svg", {
    query: "?raw",
    import: "default",
    eager: true
  });
  var manifest = icons_manifest_default;
  var mapResourceMap = resources_map_icon_map_default;
  function findSvgRaw(suffix) {
  ...
  function normalizeSvg(raw, size) {
    if (!raw) return "";
    let out = raw.replace(/stroke="#e8d88a"/gi, 'stroke="currentColor"').replace(/stroke-width="1\.5"/g, 'stroke-width="1.5"');
    if (size != null) {
  ...
  function brandIconSvg(id, size = 24) {
  ...
  function mapResourceIconSvg(key, size = 24) {
  ...
  var tokens_default = "/* The Game \u2014 Design System v1 (1E \xB7 Painted Imperial) \u2014 design tokens\r\n * \u2744 FROZEN v1.0 \xB7 2026-07-01 \xB7 decyzje 1B\u20138A zamkni\u0119te.\r\n * NIE zmienia\u0107 warto\u015Bci bez nowej dyspozycji w WYMIANA-UI-DESIGN.md.\r\n * Dyplomacja = u\u015Bcisk d\u0142oni \xB7 pora\u017Cka = --tg-red #c84040 \xB7 zero emoji. */\r\n:root {\r\n  /* color */\r\n  --tg-bg-deep:        #080a12; /* t\u0142o gry, ekrany pe\u0142ne */\r\n  --tg-gold-primary:   #e8d88a; /* tytu\u0142y, ranty, akcenty */\r\n  --tg-gold-dim:       #a08030; /* ornamenty, ramki 2-rz\u0119dne */\r\n  --tg-text-primary:   #e8e0c8; /* tekst (pergamin) */\r\n  --tg-text-muted:     #8a8070; /* podtytu\u0142y, footery */\r\n  --tg-panel-bg:       #121820; /* t\u0142o paneli */\r\n  --tg-science-blue:   #5a9bd4; /* nauka, linki info */\r\n  --tg-green:          #50b070; /* sukces, przyrost */\r\n  --tg-red:            #c84040; /* wojna, alert */\r\n  --tg-orange:         #d08030; /* ostrze\u017Cenia */\r\n\r\n  /* gradients / effects */\r\n  --tg-panel-grad:     linear-gradient(180deg, rgba(18,24,32,.96), rgba(8,10,16,.96));\r\n  --tg-btn-primary:    linear-gradient(180deg, #f0dc88, #b99a28);\r\n  --tg-medallion-bg:   radial-gradient(circle at 38% 30%, #1a2230, #0a0d14);\r\n  --tg-glow-gold:      0 0 24px rgba(232,216,138,.28);\r\n\r\n  /* type */\r\n  --tg-font-title: Georgia, 'Times New Roman', serif;   /* nag\u0142\xF3wki, nazwy */\r\n  --tg-font-ui:    'Segoe UI', Tahoma, sans-serif;       /* UI, liczby, przyciski */\r\n\r\n  /* geometry */\r\n  --tg-radius-btn:   8px;\r\n  --tg-radius-panel: 12px;\r\n  --tg-border-gold:  2px solid rgba(232,216,138,.45);\r\n  --tg-rant:         2px solid var(--tg-gold-dim); /* rant medalionu domy\u015Blny */\r\n  --tg-rant-active:  2px solid var(--tg-gold-primary);\r\n}\r\n\r\n/* Medalion ikony (1E): stroke-only line icon w \u015Brodku */\r\n.tg-medallion {\r\n  border-radius: 50%;\r\n  background: var(--tg-medallion-bg);\r\n  border: var(--tg-rant);\r\n  box-shadow: inset 0 2px 4px rgba(232,216,138,.16), 0 4px 12px rgba(0,0,0,.55);\r\n  color: var(--tg-gold-primary);\r\n  display: inline-flex; align-items: center; justify-content: center;\r\n}\r\n.tg-medallion--active { border: var(--tg-rant-active); box-shadow: inset 0 2px 4px rgba(232,216,138,.22), var(--tg-glow-gold); color: #f4e6a8; }\r\n\r\n/* Przycisk primary (4C/1E) */\r\n.tg-btn-primary {\r\n  background: var(--tg-btn-primary);\r\n  border: 1px solid #6a5212; border-top-color: #f8eea8;\r\n  color: #2e2708; font-family: var(--tg-font-ui); font-weight: 700;\r\n  letter-spacing: .14em; text-transform: uppercase;\r\n  border-radius: var(--tg-radius-btn); cursor: pointer;\r\n  box-shadow: inset 0 1px 0 rgba(255,255,255,.4), 0 6px 18px rgba(232,216,138,.2);\r\n}\r\n.tg-btn-default {\r\n  background: linear-gradient(180deg,#161c28,#0a0d14);\r\n  border: 2px solid rgba(232,216,138,.4); color: var(--tg-gold-primary);\r\n  font-family: var(--tg-font-ui); font-weight: 600; letter-spacing: .14em;\r\n  text-transform: uppercase; border-radius: var(--tg-radius-btn); cursor: pointer;\r\n}\r\n\r\n/* Panel (5C) */\r\n.tg-panel {\r\n  border: var(--tg-border-gold); border-radius: var(--tg-radius-panel);\r\n  background: var(--tg-panel-grad); box-shadow: 0 12px 40px rgba(0,0,0,.6);\r\n}\r\n";
...
`;
  var ROOT_STYLE_ID = "civ-brand-root-css-w2-scroll";
  function ensureBrandRootTokens() {
  ...
  // src/ui/leaderPortraits.ts
  var import_meta2 = {};
  var LEADER_MAP = {};
  for (const civ of civs_default.cywilizacje) {
  ...
  var CIV_MATCH_CANDIDATES = civs_default.cywilizacje.filter((c) => c.ikonaId).map((c) => ({
    icon: c.ikonaId.toLowerCase(),
    keys: [c.ikonaId, c.Cywilizacja].filter((s) => !!s).map(foldDiacritics)
  }));
  var CIV_DISPLAY_NAME_BY_ICON = {};
  for (const civ of civs_default.cywilizacje) {
    if (civ.ikonaId && civ.Cywilizacja) {
      CIV_DISPLAY_NAME_BY_ICON[civ.ikonaId.toLowerCase()] = civ.Cywilizacja;
    }
  }
  var PORTRAIT_MODULES = import_meta2.glob("../assets/portrety/*.jpg", { eager: true, import: "default" });
  var PORTRAIT_MAP = {};
  var FILE_RE = /portrait-([a-z0-9]+)-(kamien|braz|zelazo)\.jpg$/i;
  for (const [path, url] of Object.entries(PORTRAIT_MODULES)) {
    const m = FILE_RE.exec(path);
    if (!m) continue;
    const civId = m[1].toLowerCase();
    const epoch = m[2].toLowerCase();
    (PORTRAIT_MAP[civId] ?? (PORTRAIT_MAP[civId] = {}))[epoch] = url;
  }

  // src/ui/diploUiSkin.ts
  function ensureDiploBrandScope() {
    ensureBrandRootTokens();
  }
  var DIPLO_1E_SHARED_CSS = `
...
`;
  ...
  function formatBasketItemBrief(item, ctx2) {
    const perTurn = ctx2?.perTurn === true;
    const turns = ctx2?.turns;
    switch (item.typ) {
      case "zloto": {
  ...
  function formatBasketListBrief(items, ctx2) {
    if (!items?.length) return "\u2014";
    return items.map((i) => formatBasketItemBrief(i, ctx2)).join(" \xB7 ");
  }
  ...
  // src/ui/diplomacyDealDisplay.ts
  function esc(s) {
    return s.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;");
  }
  function resourceIconHtml(label, size = 16) {
  ...
  function renderBasketItemValueHtml(item, ctx2) {
    ...
    switch (item.typ) {
      case "zloto": {
        ...
        if (perTurn) {
          const main = `${ic}<span class="da-deal-amt">${amt} \xA4</span><span class="da-deal-per">na tur\u0119</span>`;
          if (turns != null && turns > 0) {
            return main + `<span class="da-deal-total">\u0142\u0105cznie ${amt * turns} \xA4 przez ${turns} tur</span>`;
          }
          return main;
        }
        return `${ic}<span class="da-deal-amt">${amt} \xA4</span><span class="da-deal-once">jednorazowo</span>`;
      }
      case "surowiec_ilosc": {
        const pakietSize = diplomacyHandelSurowcePakietWielkosc();
        const pakiety = item.ilosc ?? 1;
        ...
        if (perTurn) {
          ...
          if (turns != null && turns > 0) {
            return main + `<span class="da-deal-total">\u0142\u0105cznie ${szt * turns} ${esc(label)} przez ${turns} tur</span>`;
          }
          return main;
        }
  ...
  // src/game/diplomacy-acceptance-points.ts
  ...
  // src/ui/diplomacyAcceptanceBalance.ts
  ...
  function pwTipAttr() {
    return ' title="' + esc2(PW_EXCHANGE_TOOLTIP) + '"';
  }
  ...
  function renderPnBalancePanelFromBasket(givePn, receivePn, relTotal, actionLabel = "Wymiana") {
    if (givePn == null || receivePn == null) {
      return '<div class="da-pn-balance-bar idle da-pn-balance-bar--basket"><div class="da-pn-bal-head">' + pwTitleHeadHtml() + '</div><div class="da-pn-bal-empty">Uzupe\u0142nij koszyk \u2014 warto\u015Bci PW pojawi\u0105 si\u0119 tutaj.</div></div>';
    }
    ...
    const hint = accepted ? balancePn > 0 ? `Nadwy\u017Cka ${balancePn} PW` : "R\xF3wno \u2014 spe\u0142nia" : `Brakuje ${Math.abs(balancePn)} PW`;
    const verdict = accepted ? balancePn > 0 ? "Partner prawdopodobnie przyjmie \u2014 nadwy\u017Cka " + balancePn + " PW" : "R\xF3wno \u2014 partner spe\u0142nia oczekiwania przy tej Relacji" : "Poni\u017Cej progu fair min (" + fairMin + " PW) \u2014 ryzyko odrzucenia";
    return '<div class="da-pn-balance-bar ' + balCls + ' da-pn-balance-bar--basket"><div class="da-pn-bal-head">' + pwTitleHeadHtml() + '<span class="da-pn-bal-deal">' + esc2(actionLabel) + '</span></div><div class="da-pn-bal-cols"><div class="da-pn-bal-cell my"><span class="da-pn-bal-lbl">My oddajemy</span>' + pwAmountHtml(givePn) + '</div><div class="da-pn-bal-cell center ' + balCls + '"><span class="da-pn-bal-lbl">Bilans (Oni)</span><span class="da-pn-bal-num ' + deltaCls + '"' + pwTipAttr() + ">" + esc2(delta) + '</span><span class="da-pn-bal-hint">' + esc2(hint) + '</span></div><div class="da-pn-bal-cell they"><span class="da-pn-bal-lbl">Oni oddaj\u0105</span>' + pwAmountHtml(receivePn) + '</div></div><div class="da-pn-bal-meta">Fair min @ Rel ' + relTotal + ": " + fairMin + ' PW</div><div class="da-pn-bal-verdict ' + (accepted ? "ok" : "no") + '">' + esc2(verdict) + "</div></div>";
  }

  // src/ui/diplomacyNegotiationModal.ts
  function proposalActionIdFromPayload(payload) {
  ...
  // src/ui/diplomacyTradeBasket.ts
  var STYLE_ID = "civ-diplo-basket-css-1e";
  var overlay = null;
  var TYP_LABELS = {
    zloto: "Pieni\u0105dze (\xA4)",
    praca: "Praca",
  ...
  function cdbIconWrap(svg) {
    if (!svg) return "";
    return '<span class="cdb-chip-ic">' + svg + "</span>";
  }
  function goldChipIconHtml(size = 24) {
    const svg = mapResourceIconSvg("Z\u0142oto", size) || mapResourceIconSvg("zloto", size) || brandIconSvg("res-treasury", size);
    return cdbIconWrap(svg);
  }
  function typChipIconHtml(typ, resourceId) {
  ...
  function buildChipBtn(cls, value, side, selected, iconHtml, label, extraAttrs = "") {
    return '<button type="button" class="cdb-chip ' + cls + (selected ? " selected" : "") + '" data-side="' + side + '" data-value="' + esc3(value) + '"' + extraAttrs + ">" + iconHtml + '<span class="cdb-chip-lbl">' + esc3(label) + "</span></button>";
  }
  function qtyStepperHtml(inputClass, side, value, min = 1, max) {
    const maxAttr = max != null ? ' max="' + max + '"' : "";
    return '<div class="cdb-qty-stepper"><button type="button" class="cdb-qty-step dip-muted-btn" data-side="' + side + '" data-target="' + inputClass + '" data-delta="1">+1</button><button type="button" class="cdb-qty-step dip-muted-btn" data-side="' + side + '" data-target="' + inputClass + '" data-delta="10">+10</button><button type="button" class="cdb-qty-step dip-muted-btn" data-side="' + side + '" data-target="' + inputClass + '" data-delta="100">+100</button><input type="number" class="' + inputClass + '" data-side="' + side + '" value="' + value + '" min="' + min + '"' + maxAttr + " /></div>";
  }
  var WITHDRAWN_BASKET_ACCESS_TYPES = /* @__PURE__ */ new Set(["zloze", "surowiec_boolean"]);
  var PROG_HANDEL_REL = 100;
  function resolveTempo(ctx2) {
    return ctx2.tempoGry ?? "standardowa";
  }
  function basketPnOpts(ctx2, side) {
    return {
      difficulty: ctx2.difficulty ?? "normal",
      proposerOwnerId: 0,
      playerOwnerId: 0,
      side,
      tempo: resolveTempo(ctx2)
    };
  }
  function sumBasketPn(items, ctx2, side) {
    return diplomacySumPn(toPnItems(items, ctx2), basketPnOpts(ctx2, side));
  }
  function toPnItems(items, ctx2) {
    const tempo = resolveTempo(ctx2);
...
/* Panel PN \u2014 wsp\xF3lny uk\u0142ad ze sto\u0142em negocjacji (diplomacyAcceptanceBalance.ts). */
...
`;
  ...
  function defaultTechOptions() {
    return (tech_default.technologie ?? []).filter((t) => typeof t.Technologia === "string").map((t) => ({ id: t.Technologia, label: t.Technologia }));
  }
  var FALLBACK_QUANTITY_MAX_PAKIETY = 99;
  function defaultQuantityResourceOptions() {
    const cat = diplomacyHandelSurowceCatalog();
    const pakiet = diplomacyHandelSurowcePakietWielkosc();
    return Object.keys(cat).map((id) => ({
      id,
      label: id.charAt(0).toUpperCase() + id.slice(1) + " \xD7" + pakiet + " (pakiet)",
      maxPakiety: FALLBACK_QUANTITY_MAX_PAKIETY
    }));
  }
  function basketHasResourceAccess(...lists) {
    for (const items of lists) {
      if (items.some((i) => i.typ === "zloze" || i.typ === "surowiec_boolean")) return true;
    }
    return false;
  }
  function basketHasQuantityResource(...lists) {
    for (const items of lists) {
      if (items.some((i) => i.typ === "surowiec_ilosc")) return true;
    }
    return false;
  }
  function defaultTreatyState(actionId, initial) {
    return {
  ...
  function treatySectionHtml(actionId, ctx2, state) {
    const sub = ctx2.aiCounterOffer ? '<p class="cdb-sub">' + esc3(ctx2.aiCounterOffer) + "</p>" : "";
    let body = "";
    switch (actionId) {
      case "2":
        body = '<label for="cdb-treaty-turns">Czas paktu (tur)</label><input type="number" id="cdb-treaty-turns" class="cdb-treaty-turns" value="' + state.turns + '" min="10" max="20" /><p class="cdb-sub">Z\u0142amanie: \u221230 Relacja, \u221220 Zaufanie</p>';
        break;
      case "3":
        body = '<label>Typ sojuszu</label><select id="cdb-treaty-alliance" class="cdb-treaty-alliance"><option value="pelny"' + (state.allianceKind === "pelny" ? " selected" : "") + '>Sojusz pe\u0142ny (wojna sojusznika = twoja)</option><option value="defensywny"' + (state.allianceKind === "defensywny" ? " selected" : "") + ">Sojusz defensywny (atak na sojusznika)</option></select>";
        break;
      case "4": {
        const feeC = ctx2.borderFeeCivil ?? 20;
        const feeM = ctx2.borderFeeMilitary ?? 40;
        body = '<label>Traktat przemarszu</label><div class="cdb-row" style="display:flex;gap:8px;align-items:center;margin:6px 0"><input type="checkbox" id="cdb-treaty-mil" class="cdb-treaty-mil"' + (state.borderMilitary ? " checked" : "") + ' /><label for="cdb-treaty-mil" style="margin:0">Wariant wojskowy (+ op\u0142ata)</label></div><p class="cdb-sub">Op\u0142ata cywilne: ' + feeC + " \xA4 \xB7 wojskowe: " + feeM + " \xA4 (jednorazowo)</p>";
        break;
      }
      case "8":
        body = '<label>Tryb</label><select id="cdb-treaty-trib-mode" class="cdb-treaty-trib-mode"><option value="demand"' + (state.tributeMode === "demand" ? " selected" : "") + '>\u017B\u0105daj trybutu</option><option value="offer"' + (state.tributeMode === "offer" ? " selected" : "") + '>Zaproponuj trybut (uniknij wojny)</option></select><label for="cdb-treaty-gpt">Kwota \xA4/tur\u0119</label><input type="number" id="cdb-treaty-gpt" class="cdb-treaty-gpt" value="' + state.goldPerTurn + '" min="10" /><label for="cdb-treaty-trib-turns">Czas (tur, 0 = bezterminowy)</label><input type="number" id="cdb-treaty-trib-turns" class="cdb-treaty-trib-turns" value="' + state.tributeTurns + '" min="0" />';
        break;
      case "12":
        body = '<label for="cdb-treaty-wasal-gpt">Trybut wasala \xA4/tur\u0119</label><input type="number" id="cdb-treaty-wasal-gpt" class="cdb-treaty-wasal-gpt" value="' + state.goldPerTurn + '" min="10" /><p class="cdb-sub">Wasal zachowuje terytorium \xB7 p\u0142aci trybut co tur\u0119</p>';
        break;
      case "10":
        body = '<p class="cdb-sub">Zako\u0144czenie wojny \u2014 wymagana oferta PW (baza 500, modyfikator Relacji \xB190%). Do\u0142\xF3\u017C z\u0142oto lub surowce w koszyku poni\u017Cej.</p>';
        break;
      default:
        body = '<p class="cdb-sub">Brak dodatkowych warunk\xF3w traktatu.</p>';
    }
    return '<div class="cdb-treaty">' + sub + '<div class="cdb-treaty-title">Warunki traktatu</div>' + body + "</div>";
  }
  function readTreatyStateFromDom(actionId, prev) {
    const state = { ...prev };
    if (actionId === "2") {
      const turns = parseInt(document.querySelector(".cdb-treaty-turns")?.value ?? "15", 10);
      state.turns = Math.max(10, Math.min(20, turns));
    } else if (actionId === "3") {
      const v = document.querySelector(".cdb-treaty-alliance")?.value;
      state.allianceKind = v === "defensywny" ? "defensywny" : "pelny";
    } else if (actionId === "4") {
      state.borderMilitary = document.querySelector(".cdb-treaty-mil")?.checked ?? false;
    } else if (actionId === "8") {
      const mode = document.querySelector(".cdb-treaty-trib-mode")?.value;
      state.tributeMode = mode === "offer" ? "offer" : "demand";
      state.goldPerTurn = parseInt(document.querySelector(".cdb-treaty-gpt")?.value ?? "10", 10);
      state.tributeTurns = parseInt(document.querySelector(".cdb-treaty-trib-turns")?.value ?? "0", 10);
    } else if (actionId === "12") {
      state.goldPerTurn = parseInt(document.querySelector(".cdb-treaty-wasal-gpt")?.value ?? "10", 10);
    }
    return state;
  }
  function validateTreatyForm(actionId, state) {
    switch (actionId) {
      case "2":
      ...
      case "8":
        if (state.goldPerTurn < 10) {
          return { valid: false, reason: "Trybut: minimum 10 \xA4/tur\u0119" };
        }
        break;
      case "12":
        if (state.goldPerTurn < 10) {
          return { valid: false, reason: "Trybut wasala: minimum 10 \xA4/tur\u0119" };
        }
        break;
    }
    return { valid: true };
  }
  function treatySummaryHtml(action2, treatyState, giveItems, receiveItems, ctx2, dealTurns, resourceTradeMode) {
    ...
    const cywId = proposalActionIdFromPayload(payload);
    const rel = ctx2.relacjaTotal ?? 100;
    const { actionId: _aid, ...proposalFields } = payload;
    const sides = computePlayerAcceptanceSides(cywId, proposalFields, rel, false);
    ...
    if (bil != null && bil > 0 || myPw > 0 || theirPw > 0) {
      html += renderPnBalancePanelFromBasket(myPw, theirPw, rel, action2.label);
    }
    if (giveItems.length === 0 && receiveItems.length === 0) {
      return html;
    }
    const givePn = sumBasketPn(giveItems, ctx2, "give") ?? 0;
    const receivePn = sumBasketPn(receiveItems, ctx2, "receive") ?? 0;
    const net = Math.max(0, givePn - receivePn);
    html += '<div class="cdb-summary"><div class="cdb-basket-opt-title">Do\u0142\xF3\u017C do umowy (koszyk PW)</div>';
    html += "<div>Oddajesz: <b>" + givePn + " PW</b>";
    if (receiveItems.length > 0) html += " \xB7 Dostajesz: <b>" + receivePn + " PW</b>";
    html += "</div>";
    if (net > 0) {
  ...
  function buildTreatyPayload(actionId, state, ctx2, giveItems, receiveItems, dealTurns, resourceTradeMode) {
    ...
    switch (actionId) {
      ...
      case "4":
        ...
        payload.goldOnce = state.borderMilitary ? ctx2.borderFeeMilitary ?? 40 : ctx2.borderFeeCivil ?? 20;
        break;
      case "8":
    ...
    if (giveItems.length > 0) {
      ...
      payload.givePn = sumBasketPn(giveItems, ctx2, "give") ?? void 0;
    }
    if (receiveItems.length > 0) {
      payload.receiveItems = receiveItems;
      payload.receivePn = sumBasketPn(receiveItems, ctx2, "receive") ?? void 0;
    }
  ...
  function validateBasketForm(mode, actionId, giveItems, receiveItems, ctx2, dealTurns, resourceTradeMode, blocked, treatyState) {
    if (blocked) {
    ...
    if (mode === "treaty") {
      ...
      if (giveItems.length > 0 && receiveItems.length > 0) {
        const givePn2 = sumBasketPn(giveItems, ctx2, "give");
        const receivePn2 = sumBasketPn(receiveItems, ctx2, "receive");
        if (givePn2 == null || receivePn2 == null) {
        ...
        if (sumBasketPn(items, ctx2, "give") == null) {
          return { valid: false, reason: "Nie mo\u017Cna wyceni\u0107 pozycji koszyka \u2014 sprawd\u017A typy i ilo\u015Bci" };
        }
      }
      const hasResourceAccess2 = basketHasResourceAccess(giveItems, receiveItems);
      const hasQtyRes2 = !hasResourceAccess2 && basketHasQuantityResource(giveItems, receiveItems);
      const needsTurns2 = hasResourceAccess2 || hasQtyRes2 && resourceTradeMode === "per_turn";
      if (needsTurns2 && (dealTurns < 1 || dealTurns > 20)) {
    ...
    const givePn = sumBasketPn(giveItems, ctx2, "give");
    const receivePn = mode === "trade" ? sumBasketPn(receiveItems, ctx2, "receive") : 0;
  ...
  function dealDurationHtml(turns, visible, label = "Czas umowy (tur, max 20)", sub = "Dost\u0119p do surowc\xF3w trwa przez wybrany czas. Po wyga\u015Bni\u0119ciu umowa wymaga odnowienia (re-negocjacji).") {
    if (!visible) return "";
    const turnChips = [5, 10, 15, 20].map(
      (t) => '<button type="button" class="cdb-chip cdb-chip-turn' + (turns === t ? " selected" : "") + '" data-turns="' + t + '">' + t + "</button>"
    ).join("");
    return '<div class="cdb-duration"><label for="cdb-deal-turns">' + esc3(label) + '</label><div class="cdb-chip-row cdb-turn-presets">' + turnChips + "</div>" + qtyStepperHtml("cdb-deal-turns", "deal", turns, 1, 20) + '<p class="cdb-sub">' + esc3(sub) + "</p></div>";
  }
  function resourceTradeModeHtml(mode, visible) {
    if (!visible) return "";
    const onceIc = cdbIconWrap(brandIconSvg("chip-crate", 22));
    const perTurnIc = cdbIconWrap(brandIconSvg("ui-end-turn", 22));
    return '<div class="cdb-duration"><label>Tryb wymiany</label><div class="cdb-chip-row">' + buildChipBtn("cdb-chip-mode", "once", "deal", mode === "once", onceIc, "Jednorazowo") + buildChipBtn("cdb-chip-mode", "per_turn", "deal", mode === "per_turn", perTurnIc, "Co tur\u0119") + '</div><input type="hidden" class="cdb-res-mode" value="' + mode + '" /></div>';
  }
  function dealSettingsBlockHtml(resourceTradeMode, dealTurns, showMode, showDuration, dealDurationLabel, dealDurationSub, hintWhenIdle) {
    let html = '<div class="cdb-deal-settings">';
    html += '<div class="cdb-deal-settings-title">Czas umowy</div>';
    if (hintWhenIdle) {
      html += '<p class="cdb-sub">' + esc3(hintWhenIdle) + "</p>";
    }
  ...
  function buildAddForm(side, ctx2, mode) {
    if (mode === "gift" && side === "receive") return "";
    const prefix = side === "give" ? "give" : "recv";
    const availableTypes = Object.keys(TYP_LABELS).filter((t) => {
      ...
      if (t === "tech" && side === "receive") {
        const rel = ctx2.relacjaTotal ?? 0;
        return rel >= (ctx2.progHandelRelacja ?? PROG_HANDEL_REL);
      }
      return true;
    });
    const defaultTyp = availableTypes[0] ?? "zloto";
    const typChips = availableTypes.map(
      (t) => buildChipBtn(
        "cdb-chip-typ",
        t,
        prefix,
        ...
        ' title="' + esc3(TYP_LABELS[t]) + '"'
      )
    ).join("");
    const cities = ctx2.cityOptions ?? [];
    const defaultCity = cities[0]?.id ?? "";
    const cityChips = cities.length > 0 ? cities.map(
      (c, i) => buildChipBtn(
        "cdb-chip-city",
        c.id,
        prefix,
    ...
    ).join("") : '<span class="cdb-sub">\u2014 brak miast (SILNIK) \u2014</span>';
    const techs = ctx2.techOptions ?? defaultTechOptions().map((t) => ({ ...t, suggestedPrice: 0 }));
    const defaultTech = techs[0]?.id ?? "";
    const techChips = techs.map(
      (t, i) => buildChipBtn(
        "cdb-chip-tech",
        t.id,
        prefix,
    ...
    const qtyResources = side === "give" ? ctx2.giveQuantityResourceOptions ?? defaultQuantityResourceOptions() : ctx2.receiveQuantityResourceOptions ?? defaultQuantityResourceOptions();
    const pakiet = diplomacyHandelSurowcePakietWielkosc();
    ...
    const qtyResChips = qtyResources.map((r, i) => {
      ...
      return buildChipBtn(
        ...
        short,
        ' data-max="' + r.maxPakiety + '" title="' + esc3(label) + " \xD7" + pakiet + '"'
      );
    }).join("");
    const qtyResFirstMax = qtyResources[0]?.maxPakiety ?? 1;
    const zywnHint = diplomacyZywnoscNaPn();
    return '<div class="cdb-add" data-side="' + prefix + '"><input type="hidden" class="cdb-typ cdb-typ-hidden" data-side="' + prefix + '" value="' + defaultTyp + '" /><div class="cdb-add-section"><div class="cdb-add-section-title">Co dodajesz</div><div class="cdb-chip-grid cdb-typ-chips">' + typChips + '</div></div><div class="cdb-fields-extra visible" data-extra="' + prefix + '-qty"><label>Ilo\u015B\u0107</label>' + qtyStepperHtml("cdb-qty", prefix, 10) + '</div><div class="cdb-fields-extra" data-extra="' + prefix + '-city"><label>Miasto (spichlerz)</label><div class="cdb-chip-grid cdb-city-chips">' + cityChips + '</div><input type="hidden" class="cdb-city" data-side="' + prefix + '" value="' + esc3(defaultCity) + '" /><label>Ilo\u015B\u0107 \u017Cywno\u015Bci <span style="color:#7a8494">(1 PW = ' + zywnHint + ")</span></label>" + qtyStepperHtml("cdb-food-qty", prefix, 10) + '</div><div class="cdb-fields-extra" data-extra="' + prefix + '-tech"><label>Technologia</label><div class="cdb-chip-grid cdb-tech-chips">' + techChips + '</div><input type="hidden" class="cdb-tech" data-side="' + prefix + '" value="' + esc3(defaultTech) + '" /></div><div class="cdb-fields-extra" data-extra="' + prefix + '-resqty"><label>Surowiec (pakiety \xD7' + pakiet + ')</label><div class="cdb-chip-grid cdb-resqty-chips">' + qtyResChips + '</div><input type="hidden" class="cdb-res-qty-sel" data-side="' + prefix + '" value="' + esc3(defaultResId) + '" data-max="' + qtyResFirstMax + '" /><label>Liczba pakiet\xF3w</label>' + qtyStepperHtml("cdb-res-qty-num", prefix, 1, 1, qtyResFirstMax) + '</div><button type="button" class="dip-gold-btn cdb-add-btn" data-side="' + prefix + '">+ Dodaj pozycj\u0119</button></div>';
  }
  function editableDealItemsHtml(items, side, resourceTradeMode, dealTurns) {
    if (items.length === 0) return '<span class="da-deal-empty">\u2014</span>';
    const fmtCtx = {
      perTurn: resourceTradeMode === "per_turn",
      turns: dealTurns
    };
    return items.map((item, idx) => '<div class="cdb-deal-row" data-side="' + side + '" data-idx="' + idx + '"><div class="da-deal-item">' + renderBasketItemValueHtml(item, fmtCtx) + '</div><button type="button" class="cdb-rm" data-side="' + side + '" data-idx="' + idx + '" title="Usu\u0144">\xD7</button></div>').join("");
  }
  function dealSideColumnHtml(head, colClass, items, side, resourceTradeMode, dealTurns) {
    return '<div class="da-deal-col ' + colClass + '"><div class="da-deal-col-head">' + esc3(head) + '</div><div class="da-deal-col-body" data-list="' + side + '">' + editableDealItemsHtml(items, side, resourceTradeMode, dealTurns) + "</div></div>";
  }
  function tradeDealPreviewHtml(giveItems, receiveItems, resourceTradeMode, dealTurns) {
  ...
  function summaryHtml(mode, giveItems, receiveItems, ctx2, resourceTradeMode, dealTurns) {
    const rel = ctx2.relacjaTotal ?? 0;
    const trustGained = ctx2.trustPnGainedThisTurn ?? 0;
    ...
    if (mode === "trade") {
      html += "<div>SUMA oddaj\u0119: <b>" + (givePn ?? "\u2014") + " PW</b> \xB7 SUMA dostaj\u0119: <b>" + (receivePn ?? "\u2014") + " PW</b></div>";
      if (givePn != null && receivePn != null) {
        ...
        if (dobraWola.active) {
          html += "<div>Dobra wola: <b>+" + dobraWola.zaufaniePerTura + " Zauf./tur\u0119 \xD7 " + dobraWola.tur + "</div>";
        }
        if (givePn < fairMin) {
        ...
        if (dobraWola.active) perTurn.push("+" + dobraWola.zaufaniePerTura + " Zaufania/tur\u0119 \xD7 " + dobraWola.tur + " tur");
        ...
        html += '<div class="cdb-split"><div>Jednorazowo: <b>' + (oneShot.length > 0 ? oneShot.join(" \xB7 ") : "\u2014") + "</b></div><div>Co tur\u0119: <b>" + (perTurn.length > 0 ? perTurn.join(" \xB7 ") : "\u2014") + "</b></div></div>";
        let verdict;
        let verdictCls;
        if (givePn < fairMin) {
          ...
          verdict = "zr\xF3wnowa\u017Cona \u2014 dok\u0142adnie fair min przy tej Relacji";
          verdictCls = "neutral";
        }
        html += '<div class="cdb-verdict cdb-verdict-' + verdictCls + '">Szczeg\xF3\u0142y: ' + esc3(verdict) + "</div>";
      } else {
  ...
  function readItemFromForm(side, box, ctx2) {
    const prefix = side === "give" ? "give" : "recv";
    const typ = box.querySelector('.cdb-typ[data-side="' + prefix + '"]')?.value;
    if (!typ) return null;
    switch (typ) {
      case "zloto":
      case "praca": {
        const qty = parseInt(box.querySelector('.cdb-qty[data-side="' + prefix + '"]')?.value ?? "0", 10);
        if (qty <= 0) return null;
        return { typ, id: typ, ilosc: qty };
      }
      case "zywnosc": {
        const cityId = box.querySelector('.cdb-city[data-side="' + prefix + '"]')?.value;
        const qty = parseInt(box.querySelector('.cdb-food-qty[data-side="' + prefix + '"]')?.value ?? "0", 10);
        if (!cityId || qty <= 0) return null;
        return { typ, id: cityId, cityId, ilosc: qty };
      }
      case "zloze": {
        const id = box.querySelector('.cdb-zloze[data-side="' + prefix + '"]')?.value;
        if (!id) return null;
        return { typ, id };
      }
      case "tech": {
        const id = box.querySelector('.cdb-tech[data-side="' + prefix + '"]')?.value;
        if (!id) return null;
        return { typ, id };
      }
      case "jednostka": {
        const id = box.querySelector('.cdb-unit[data-side="' + prefix + '"]')?.value;
        if (!id) return null;
        return { typ, id };
      }
      case "surowiec_boolean": {
        const id = box.querySelector('.cdb-res-bool[data-side="' + prefix + '"]')?.value;
        if (!id) return null;
        return { typ, id };
      }
      case "surowiec_ilosc": {
        const hidden = box.querySelector('.cdb-res-qty-sel[data-side="' + prefix + '"]');
        const id = hidden?.value;
        if (!id) return null;
        const maxAttr = parseInt(hidden?.getAttribute("data-max") ?? "0", 10);
        const rawQty = parseInt(
          box.querySelector('.cdb-res-qty-num[data-side="' + prefix + '"]')?.value ?? "0",
          10
        );
  ...
  function updateTypFields(box, side) {
    const prefix = side === "give" ? "give" : "recv";
    const typ = box.querySelector('.cdb-typ[data-side="' + prefix + '"]')?.value ?? "zloto";
  ...
  function selectChipInGroup(btn, chipClass, hiddenSelector, onSelect) {
    ...
    const hidden = addBox.querySelector(hiddenSelector + '[data-side="' + side + '"]');
    if (hidden) {
      hidden.value = value;
      const max = btn.getAttribute("data-max");
      if (max != null) hidden.setAttribute("data-max", max);
    }
    onSelect?.(value, btn.getAttribute("data-max") ? parseInt(btn.getAttribute("data-max"), 10) : void 0);
  }
  function renderBasket(box, mode, action2, ctx2, giveItems, receiveItems, dealTurns, resourceTradeMode, treatyState) {
    const rel = ctx2.relacjaTotal ?? 0;
    const progHandel = ctx2.progHandelRelacja ?? PROG_HANDEL_REL;
    const progDar = ctx2.progDarRelacja ?? diplomacyProgDarRelacja();
    let blocked = "";
    ...
    const title = mode === "gift" ? "Prezent / dar" : action2.label;
    const sub = mode === "treaty" ? "Ustal warunki traktatu \u2014 wymiana PW jest opcjonalna \xB7 partner: <strong>" + esc3(ctx2.civName) + "</strong>" : mode === "gift" ? "Oddajesz bez towaru w zamian \xB7 Rel \u2265 " + progDar : "Wymiana dwustronna \xB7 Rel \u2265 " + progHandel + " \xB7 partner: <strong>" + esc3(ctx2.civName) + "</strong>";
    const basketModeForForm = mode === "treaty" ? "trade" : mode;
    ...
    const giveCol = '<div class="cdb-col"><div class="cdb-col-title">' + (mode === "treaty" ? "My oddajemy (opcjonalnie)" : "Dodaj do oferty") + "</div>" + (blocked ? "" : buildAddForm("give", ctx2, basketModeForForm)) + "</div>";
    const recvCol = showReceiveCol ? '<div class="cdb-col"><div class="cdb-col-title">' + (mode === "treaty" ? "Oni oddaj\u0105 (opcjonalnie)" : "Dodaj do kontrpropozycji") + "</div>" + (blocked ? "" : buildAddForm("receive", ctx2, basketModeForForm)) + "</div>" : "";
    const dealPreview = showDealPreview ? tradeDealPreviewHtml(giveItems, receiveItems, resourceTradeMode, dealTurns) : mode === "gift" && !blocked ? '<div class="cdb-deal-preview"><div class="da-deal-table">' + dealSideColumnHtml("Co oddajesz", "da-deal-col-we", giveItems, "give", "once", dealTurns) + "</div></div>" : "";
    const hasResourceAccess = basketHasResourceAccess(giveItems, receiveItems);
    ...
    const showDealDuration = showReceiveCol && (hasResourceAccess || hasQtyRes && resourceTradeMode === "per_turn" || showResModeSelector && resourceTradeMode === "per_turn");
    const dealDurationLabel = hasResourceAccess ? "Czas umowy (tur, max 20)" : "Co ile tur trwa wymiana (tur, max 20)";
    const dealDurationSub = hasResourceAccess ? "Dost\u0119p do surowc\xF3w trwa przez wybrany czas. Po wyga\u015Bni\u0119ciu umowa wymaga odnowienia (re-negocjacji)." : "Surowiec i zap\u0142ata p\u0142yn\u0105 CO TUR\u0118 przez wybrany czas. Deal znika po wyga\u015Bni\u0119ciu, zerwaniu traktatu lub wojnie.";
    const dealSettingsHint = !hasQtyRes && !hasResourceAccess ? 'Tryb \u201ECo tur\u0119" i czas obowi\u0105zuj\u0105 po dodaniu surowca (pakiety) do koszyka.' : void 0;
    const dealSettings = blocked || !showReceiveCol ? "" : dealSettingsBlockHtml(
      resourceTradeMode,
      dealTurns,
      showResModeSelector,
      showDealDuration,
    ...
    const invalidHtml = !validation.valid && validation.reason ? '<div class="cdb-invalid">' + esc3(validation.reason) + "</div>" : "";
    const treatyHtml = mode === "treaty" ? treatySectionHtml(action2.id, ctx2, treatyState) : "";
    const basketOptIntro = mode === "treaty" && !blocked ? '<div class="cdb-basket-opt"><div class="cdb-basket-opt-title">' + (treatyBasketsEmpty ? "Opcjonalnie \u2014 do\u0142\xF3\u017C wymian\u0119 PW (nie jest wymagana do zaproponowania traktatu)" : "Do\u0142\xF3\u017Cona wymiana PW") + "</div>" : "";
    const basketOptClose = mode === "treaty" && !blocked ? "</div>" : "";
    const summaryBlock = mode === "treaty" ? treatySummaryHtml(action2, treatyState, giveItems, receiveItems, ctx2, dealTurns, resourceTradeMode) : summaryHtml(mode, giveItems, receiveItems, ctx2, resourceTradeMode, dealTurns);
    box.className = "civ-diplo-basket" + (mode === "gift" ? " cdb-gift" : "");
    box.innerHTML = "<h3>" + esc3(title) + '</h3><div class="cdb-sub">' + sub + "</div>" + blocked + treatyHtml + basketOptIntro + dealPreview + dealSettings + (blocked ? "" : '<div class="cdb-cols">' + giveCol + recvCol + "</div>") + basketOptClose + (blocked ? "" : summaryBlock) + invalidHtml + '<div class="cdb-btns"><button type="button" class="dip-muted-btn cdb-cancel">Anuluj</button><button type="button" class="dip-gold-btn cdb-submit"' + (blocked || !validation.valid ? " disabled" : "") + ">Zaproponuj</button></div>";
  }
  function showTradeBasketModal(mode, action2, ctx2, onSubmit, onCancel, initial) {
    closeModal();
    ensureStyles();
    let giveItems = stripWithdrawnResourceAccessItems(initial?.giveItems ?? []);
    let receiveItems = stripWithdrawnResourceAccessItems(initial?.receiveItems ?? []);
    let dealTurns = initial?.turns != null ? Math.max(1, Math.min(20, initial.turns)) : 15;
    let resourceTradeMode = initial?.resourceTradeMode ?? "once";
    let treatyState = defaultTreatyState(action2.id, initial);
    ...
    const readDealTurnsFromDom = () => {
      const inp = box.querySelector(".cdb-deal-turns");
      if (inp) dealTurns = Math.max(1, Math.min(20, parseInt(inp.value, 10) || 15));
    };
    const readResourceTradeModeFromDom = () => {
      const hidden = box.querySelector(".cdb-res-mode");
      if (hidden) resourceTradeMode = hidden.value === "per_turn" ? "per_turn" : "once";
    };
    const refresh = () => {
      readDealTurnsFromDom();
      readResourceTradeModeFromDom();
      if (mode === "treaty") treatyState = readTreatyStateFromDom(action2.id, treatyState);
      renderBasket(box, mode, action2, ctx2, giveItems, receiveItems, dealTurns, resourceTradeMode, treatyState);
      bindEvents();
    };
    const bindEvents = () => {
      const dismiss = () => {
      ...
      box.querySelectorAll(".cdb-chip-typ").forEach((btn) => {
        btn.addEventListener("click", () => {
          ...
          selectChipInGroup(btn, "cdb-chip-typ", ".cdb-typ", (value) => {
            const prefix = side === "give" ? "give" : "recv";
            const hidden = box.querySelector('.cdb-typ[data-side="' + prefix + '"]');
      ...
      box.querySelectorAll(".cdb-chip-resqty").forEach((btn) => {
        btn.addEventListener("click", () => {
          ...
          selectChipInGroup(btn, "cdb-chip-resqty", ".cdb-res-qty-sel", (_value, max) => {
            if (side && max != null) {
              const inp = box.querySelector('.cdb-res-qty-num[data-side="' + side + '"]');
              if (inp) {
                inp.max = String(max);
      ...
      box.querySelectorAll(".cdb-chip-mode").forEach((btn) => {
        btn.addEventListener("click", () => {
          ...
          const hidden = box.querySelector(".cdb-res-mode");
          const mode2 = btn.getAttribute("data-value") === "per_turn" ? "per_turn" : "once";
          if (hidden) hidden.value = mode2;
          resourceTradeMode = mode2;
          refresh();
        });
      });
      ...
      box.querySelectorAll(".cdb-qty-step").forEach((btn) => {
        btn.addEventListener("click", () => {
          ...
          const inp = box.querySelector("." + target + '[data-side="' + side + '"]');
          if (!inp) return;
      ...
      box.querySelectorAll(".cdb-add-btn").forEach((btn) => {
        btn.addEventListener("click", () => {
          const side = btn.getAttribute("data-side") === "recv" ? "receive" : "give";
          const item = readItemFromForm(side, box, ctx2);
          if (!item) return;
      ...
      box.querySelector(".cdb-submit")?.addEventListener("click", () => {
        const blocked = mode === "trade" && (ctx2.relacjaTotal ?? 0) < (ctx2.progHandelRelacja ?? PROG_HANDEL_REL) || mode === "gift" && (ctx2.relacjaTotal ?? 0) < (ctx2.progDarRelacja ?? diplomacyProgDarRelacja());
        readDealTurnsFromDom();
        readResourceTradeModeFromDom();
        if (mode === "treaty") treatyState = readTreatyStateFromDom(action2.id, treatyState);
        const validation = validateBasketForm(
        ...
        if (mode === "treaty") {
          ...
          payload = {
            actionId: action2.id,
            giveItems,
            receiveItems: mode === "trade" ? receiveItems : void 0,
            givePn: givePn ?? void 0,
            receivePn: mode === "trade" ? receivePn ?? void 0 : 0,
            isGift: mode === "gift"
          };
          if (mode === "trade" && basketHasResourceAccess(giveItems, receiveItems)) {
            payload.turns = dealTurns;
          } else if (mode === "trade" && resourceTradeMode === "per_turn" && basketHasQuantityResource(giveItems, receiveItems)) {
            payload.resourceTradeMode = "per_turn";
            payload.turns = dealTurns;
          }
        }
  ...
  var ctx = {
    ...
    giveQuantityResourceOptions: [
      { id: "drewno", label: "Drewno \xD736 (pakiet)", maxPakiety: 12 },
      { id: "kamien", label: "Kamie\u0144 \xD736 (pakiet)", maxPakiety: 8 },
      { id: "glina", label: "Glina \xD736 (pakiet)", maxPakiety: 6 },
      { id: "cegla", label: "Ceg\u0142a \xD736 (pakiet)", maxPakiety: 4 }
    ],
    receiveQuantityResourceOptions: [
      { id: "drewno", label: "Drewno \xD736 (pakiet)", maxPakiety: 10 },
      { id: "ruda", label: "Ruda \xD736 (pakiet)", maxPakiety: 5 },
      { id: "braz", label: "Br\u0105z \xD736 (pakiet)", maxPakiety: 3 }
    ],
    techOptions: [
      { id: "Obr\xF3bka kamienia", label: "Obr\xF3bka kamienia", suggestedPrice: 80 },
      { id: "Rolnictwo", label: "Rolnictwo", suggestedPrice: 60 }
    ],
    playerSkarbiec: 500,
    trustPnGainedThisTurn: 0
  };
  function mountTradeBasketPreview() {
  ...
  return __toCommonJS(trade_basket_preview_entry_exports);
})();
