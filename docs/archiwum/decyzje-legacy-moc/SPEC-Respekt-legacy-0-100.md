...
> ⚠️ **AKTUALIZACJA 2026-06-26:** Warstwa 1 (Potęga 0–100, wagi w `diplomacy.json`) **wycofana**.  
> **Kanon:** obiektywna **Moc** (P-A, Panel-B) + `computeRespekt(Moc_A, Moc_B)` — patrz `dyspozycje/_scalone/EKONOMIA/EKONOMIA-POWER-RESPEKT-SPEC.md`.  
> Poniższy dokument zachowany jako historia; **ratio-share (sekcja C warstwa 2)** nadal aktualne.
