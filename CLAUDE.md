...
9. **Gdy jest coś do testu w roboczej — banner GOTÓW DO TESTU (Maciej 2026-08-02).** Po deployu / subagencie z bundlem: w czacie najpierw znak tekstowy `✅ GOTÓW DO TESTU` (ramka ASCII) + md5 + Ctrl+F5 + co sprawdzić. **Bez bannera Maciej nie testuje.** Reguła: `.cursor/rules/gotow-do-testu.mdc`.
