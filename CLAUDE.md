...
0a. **POTRÓJNA WARSTWA (Maciej 2026-08-05).** Po kodzie zawsze: (1) implementer `composer-2.5` → (2) osobny **adwokat diabła** `composer-2.5` → (3) Grok final. **ZAKAZ** „gotowe w kodzie” / `deploy` po samym #1. Kanon: `dyspozycje/POTROJNA-WARSTWA-WERYFIKACJI.md` · `.cursor/rules/potrojna-warstwa-weryfikacji.mdc` · `docs/decyzje/R-PROC-POTROJNA-WARSTWA.md`.
