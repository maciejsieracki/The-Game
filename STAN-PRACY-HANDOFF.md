...
**Stan na 2026-07-30 (NAJNOWSZY):** deploy ROBOCZA **`ed968c14`** (FALA 117, 00:39) — markery złóż na Wzg./Górach: `compactDepositAtEdge` + `reliefSurfaceSampler` (pierścień 0.80, fix „w środku skały"). Poprzedni: FALA 116 `7df8cf1d`. Wejście: `gra-robocza/START.html` · Ctrl+F5 + Nowa gra.
