...
export interface BuildingDef {
  ...
  Tech: string | null;
  Praca: number | null;
  Pieniądz: number | null;
  Drewno: number | null;
  Kamień: number | null;
  Deski: number | null;
  Cegła: number | null;
  Brąz: number | null;
  'Zużycie/turę': string | null;
  'Produkcja/turę': string | null;
  Utrzymanie: number | null;
  Efekt: string | null;
  Współczynnik: number | null;
  Uwagi: string | null;
}
...
export function getBuildingDef(data: GameData, nazwa: string): BuildingDef | undefined {
  return data.buildings.find(b => b.Budynek === nazwa);
}
