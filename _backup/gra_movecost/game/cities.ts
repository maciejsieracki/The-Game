 ...
 *   2. The hex is not water       -> reason 'woda'
 *   3. No existing city is closer than MIN_CITY_DISTANCE -> reason 'za blisko innego miasta'
 *
...
export function canFoundCity(
  ...
  if (hex !== undefined && hex.terenBazowy === TerenBazowy.Morze) {
    return { ok: false, reason: 'woda' };
  }
